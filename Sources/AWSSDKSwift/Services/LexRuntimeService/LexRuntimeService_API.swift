...
public struct LexRuntimeService {
    ...
    public func getSession(_ input: GetSessionRequest) -> EventLoopFuture<GetSessionResponse> {
    ...
    public func postContent(_ input: PostContentRequest) -> EventLoopFuture<PostContentResponse> {
    ...
    public func postText(_ input: PostTextRequest) -> EventLoopFuture<PostTextResponse> {
    ...
    public func putSession(_ input: PutSessionRequest) -> EventLoopFuture<PutSessionResponse> {
