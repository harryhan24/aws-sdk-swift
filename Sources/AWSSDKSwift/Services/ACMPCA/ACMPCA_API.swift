...
public struct ACMPCA {
    ...
    public func createCertificateAuthority(_ input: CreateCertificateAuthorityRequest) -> EventLoopFuture<CreateCertificateAuthorityResponse> {
        return client.send(operation: "CreateCertificateAuthority", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createCertificateAuthorityAuditReport(_ input: CreateCertificateAuthorityAuditReportRequest) -> EventLoopFuture<CreateCertificateAuthorityAuditReportResponse> {
        return client.send(operation: "CreateCertificateAuthorityAuditReport", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func createPermission(_ input: CreatePermissionRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "CreatePermission", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func deleteCertificateAuthority(_ input: DeleteCertificateAuthorityRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteCertificateAuthority", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func deletePermission(_ input: DeletePermissionRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeletePermission", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeCertificateAuthority(_ input: DescribeCertificateAuthorityRequest) -> EventLoopFuture<DescribeCertificateAuthorityResponse> {
        return client.send(operation: "DescribeCertificateAuthority", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists information about a specific audit report created by calling the CreateCertificateAuthorityAuditReport action. Audit information is created every time the certificate authority (CA) private key is used. The private key is used when you call the IssueCertificate action or the RevokeCertificate action. 
    public func describeCertificateAuthorityAuditReport(_ input: DescribeCertificateAuthorityAuditReportRequest) -> EventLoopFuture<DescribeCertificateAuthorityAuditReportResponse> {
        return client.send(operation: "DescribeCertificateAuthorityAuditReport", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getCertificateAuthorityCertificate(_ input: GetCertificateAuthorityCertificateRequest) -> EventLoopFuture<GetCertificateAuthorityCertificateResponse> {
        return client.send(operation: "GetCertificateAuthorityCertificate", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getCertificateAuthorityCsr(_ input: GetCertificateAuthorityCsrRequest) -> EventLoopFuture<GetCertificateAuthorityCsrResponse> {
        return client.send(operation: "GetCertificateAuthorityCsr", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func importCertificateAuthorityCertificate(_ input: ImportCertificateAuthorityCertificateRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "ImportCertificateAuthorityCertificate", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func issueCertificate(_ input: IssueCertificateRequest) -> EventLoopFuture<IssueCertificateResponse> {
        return client.send(operation: "IssueCertificate", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the private certificate authorities that you created by using the CreateCertificateAuthority action.
    public func listCertificateAuthorities(_ input: ListCertificateAuthoritiesRequest) -> EventLoopFuture<ListCertificateAuthoritiesResponse> {
        return client.send(operation: "ListCertificateAuthorities", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func restoreCertificateAuthority(_ input: RestoreCertificateAuthorityRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "RestoreCertificateAuthority", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func revokeCertificate(_ input: RevokeCertificateRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "RevokeCertificate", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func tagCertificateAuthority(_ input: TagCertificateAuthorityRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "TagCertificateAuthority", path: "/", httpMethod: "POST", input: input)
    }

    ///  Remove one or more tags from your private CA. A tag consists of a key-value pair. If you do not specify the value portion of the tag when calling this action, the tag will be removed regardless of value. If you specify a value, the tag is removed only if it is associated with the specified value. To add tags to a private CA, use the TagCertificateAuthority. Call the ListTags action to see what tags are associated with your CA. 
    @discardableResult public func untagCertificateAuthority(_ input: UntagCertificateAuthorityRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "UntagCertificateAuthority", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the status or configuration of a private certificate authority (CA). Your private CA must be in the ACTIVE or DISABLED state before you can update it. You can disable a private CA that is in the ACTIVE state or make a CA that is in the DISABLED state active again.
    @discardableResult public func updateCertificateAuthority(_ input: UpdateCertificateAuthorityRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "UpdateCertificateAuthority", path: "/", httpMethod: "POST", input: input)
    }
}
