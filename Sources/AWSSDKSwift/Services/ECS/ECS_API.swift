...
/**
Client object for interacting with AWS ECS service.
...
public struct ECS {
    ...
    public func createCapacityProvider(_ input: CreateCapacityProviderRequest) -> EventLoopFuture<CreateCapacityProviderResponse> {
    ...
    public func createTaskSet(_ input: CreateTaskSetRequest) -> EventLoopFuture<CreateTaskSetResponse> {
        return client.send(operation: "CreateTaskSet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables an account setting for a specified IAM user, IAM role, or the root user for an account.
    public func deleteAccountSetting(_ input: DeleteAccountSettingRequest) -> EventLoopFuture<DeleteAccountSettingResponse> {
        return client.send(operation: "DeleteAccountSetting", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes one or more custom attributes from an Amazon ECS resource.
    public func deleteAttributes(_ input: DeleteAttributesRequest) -> EventLoopFuture<DeleteAttributesResponse> {
    ...
    public func deleteTaskSet(_ input: DeleteTaskSetRequest) -> EventLoopFuture<DeleteTaskSetResponse> {
        return client.send(operation: "DeleteTaskSet", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func deregisterContainerInstance(_ input: DeregisterContainerInstanceRequest) -> EventLoopFuture<DeregisterContainerInstanceResponse> {
        return client.send(operation: "DeregisterContainerInstance", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func deregisterTaskDefinition(_ input: DeregisterTaskDefinitionRequest) -> EventLoopFuture<DeregisterTaskDefinitionResponse> {
        return client.send(operation: "DeregisterTaskDefinition", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your capacity providers.
    public func describeCapacityProviders(_ input: DescribeCapacityProvidersRequest) -> EventLoopFuture<DescribeCapacityProvidersResponse> {
    ...
    public func describeContainerInstances(_ input: DescribeContainerInstancesRequest) -> EventLoopFuture<DescribeContainerInstancesResponse> {
        return client.send(operation: "DescribeContainerInstances", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeTaskDefinition(_ input: DescribeTaskDefinitionRequest) -> EventLoopFuture<DescribeTaskDefinitionResponse> {
        return client.send(operation: "DescribeTaskDefinition", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the task sets in the specified cluster and service. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func describeTaskSets(_ input: DescribeTaskSetsRequest) -> EventLoopFuture<DescribeTaskSetsResponse> {
        return client.send(operation: "DescribeTaskSets", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes a specified task or tasks.
    public func describeTasks(_ input: DescribeTasksRequest) -> EventLoopFuture<DescribeTasksResponse> {
        return client.send(operation: "DescribeTasks", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func discoverPollEndpoint(_ input: DiscoverPollEndpointRequest) -> EventLoopFuture<DiscoverPollEndpointResponse> {
        return client.send(operation: "DiscoverPollEndpoint", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the account settings for a specified principal.
    public func listAccountSettings(_ input: ListAccountSettingsRequest) -> EventLoopFuture<ListAccountSettingsResponse> {
        return client.send(operation: "ListAccountSettings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the attributes for Amazon ECS resources within a specified target type and cluster. When you specify a target type and cluster, ListAttributes returns a list of attribute objects, one for each attribute on each resource. You can filter the list of results to a single attribute name to only return results that have that name. You can also filter the results by attribute name and value, for example, to see which container instances in a cluster are running a Linux AMI (ecs.os-type=linux). 
    public func listAttributes(_ input: ListAttributesRequest) -> EventLoopFuture<ListAttributesResponse> {
        return client.send(operation: "ListAttributes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listContainerInstances(_ input: ListContainerInstancesRequest) -> EventLoopFuture<ListContainerInstancesResponse> {
        return client.send(operation: "ListContainerInstances", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listTaskDefinitionFamilies(_ input: ListTaskDefinitionFamiliesRequest) -> EventLoopFuture<ListTaskDefinitionFamiliesResponse> {
        return client.send(operation: "ListTaskDefinitionFamilies", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of task definitions that are registered to your account. You can filter the results by family name with the familyPrefix parameter or by status with the status parameter.
    public func listTaskDefinitions(_ input: ListTaskDefinitionsRequest) -> EventLoopFuture<ListTaskDefinitionsResponse> {
        return client.send(operation: "ListTaskDefinitions", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func putAccountSetting(_ input: PutAccountSettingRequest) -> EventLoopFuture<PutAccountSettingResponse> {
        return client.send(operation: "PutAccountSetting", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies an account setting for all IAM users on an account for whom no individual account setting has been specified. Account settings are set on a per-Region basis.
    public func putAccountSettingDefault(_ input: PutAccountSettingDefaultRequest) -> EventLoopFuture<PutAccountSettingDefaultResponse> {
        return client.send(operation: "PutAccountSettingDefault", path: "/", httpMethod: "POST", input: input)
    }

    ///  Create or update an attribute on an Amazon ECS resource. If the attribute does not exist, it is created. If the attribute exists, its value is replaced with the specified value. To delete an attribute, use DeleteAttributes. For more information, see Attributes in the Amazon Elastic Container Service Developer Guide.
    public func putAttributes(_ input: PutAttributesRequest) -> EventLoopFuture<PutAttributesResponse> {
    ...
    public func putClusterCapacityProviders(_ input: PutClusterCapacityProvidersRequest) -> EventLoopFuture<PutClusterCapacityProvidersResponse> {
    ...
    public func registerContainerInstance(_ input: RegisterContainerInstanceRequest) -> EventLoopFuture<RegisterContainerInstanceResponse> {
        return client.send(operation: "RegisterContainerInstance", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func registerTaskDefinition(_ input: RegisterTaskDefinitionRequest) -> EventLoopFuture<RegisterTaskDefinitionResponse> {
        return client.send(operation: "RegisterTaskDefinition", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func runTask(_ input: RunTaskRequest) -> EventLoopFuture<RunTaskResponse> {
        return client.send(operation: "RunTask", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func startTask(_ input: StartTaskRequest) -> EventLoopFuture<StartTaskResponse> {
        return client.send(operation: "StartTask", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func stopTask(_ input: StopTaskRequest) -> EventLoopFuture<StopTaskResponse> {
        return client.send(operation: "StopTask", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func submitAttachmentStateChanges(_ input: SubmitAttachmentStateChangesRequest) -> EventLoopFuture<SubmitAttachmentStateChangesResponse> {
        return client.send(operation: "SubmitAttachmentStateChanges", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func submitContainerStateChange(_ input: SubmitContainerStateChangeRequest) -> EventLoopFuture<SubmitContainerStateChangeResponse> {
        return client.send(operation: "SubmitContainerStateChange", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func submitTaskStateChange(_ input: SubmitTaskStateChangeRequest) -> EventLoopFuture<SubmitTaskStateChangeResponse> {
        return client.send(operation: "SubmitTaskStateChange", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateClusterSettings(_ input: UpdateClusterSettingsRequest) -> EventLoopFuture<UpdateClusterSettingsResponse> {
        return client.send(operation: "UpdateClusterSettings", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateContainerAgent(_ input: UpdateContainerAgentRequest) -> EventLoopFuture<UpdateContainerAgentResponse> {
        return client.send(operation: "UpdateContainerAgent", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateContainerInstancesState(_ input: UpdateContainerInstancesStateRequest) -> EventLoopFuture<UpdateContainerInstancesStateResponse> {
        return client.send(operation: "UpdateContainerInstancesState", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateServicePrimaryTaskSet(_ input: UpdateServicePrimaryTaskSetRequest) -> EventLoopFuture<UpdateServicePrimaryTaskSetResponse> {
        return client.send(operation: "UpdateServicePrimaryTaskSet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies a task set. This is used when a service uses the EXTERNAL deployment controller type. For more information, see Amazon ECS Deployment Types in the Amazon Elastic Container Service Developer Guide.
    public func updateTaskSet(_ input: UpdateTaskSetRequest) -> EventLoopFuture<UpdateTaskSetResponse> {
        return client.send(operation: "UpdateTaskSet", path: "/", httpMethod: "POST", input: input)
    }
}
