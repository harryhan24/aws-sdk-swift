...
public struct LexModelBuildingService {
    ...
    public func createBotVersion(_ input: CreateBotVersionRequest) -> EventLoopFuture<CreateBotVersionResponse> {
        return client.send(operation: "CreateBotVersion", path: "/bots/{name}/versions", httpMethod: "POST", input: input)
    }
    ...
    public func createIntentVersion(_ input: CreateIntentVersionRequest) -> EventLoopFuture<CreateIntentVersionResponse> {
        return client.send(operation: "CreateIntentVersion", path: "/intents/{name}/versions", httpMethod: "POST", input: input)
    }
    ...
    public func createSlotTypeVersion(_ input: CreateSlotTypeVersionRequest) -> EventLoopFuture<CreateSlotTypeVersionResponse> {
        return client.send(operation: "CreateSlotTypeVersion", path: "/slottypes/{name}/versions", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func deleteBot(_ input: DeleteBotRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBot", path: "/bots/{name}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteBotAlias(_ input: DeleteBotAliasRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteBotChannelAssociation(_ input: DeleteBotChannelAssociationRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteBotVersion(_ input: DeleteBotVersionRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteBotVersion", path: "/bots/{name}/versions/{version}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteIntent(_ input: DeleteIntentRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteIntent", path: "/intents/{name}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteIntentVersion(_ input: DeleteIntentVersionRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteIntentVersion", path: "/intents/{name}/versions/{version}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteSlotType(_ input: DeleteSlotTypeRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteSlotType", path: "/slottypes/{name}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteSlotTypeVersion(_ input: DeleteSlotTypeVersionRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteSlotTypeVersion", path: "/slottypes/{name}/version/{version}", httpMethod: "DELETE", input: input)
    }
    ...
    @discardableResult public func deleteUtterances(_ input: DeleteUtterancesRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteUtterances", path: "/bots/{botName}/utterances/{userId}", httpMethod: "DELETE", input: input)
    }
    ...
    public func getBot(_ input: GetBotRequest) -> EventLoopFuture<GetBotResponse> {
        return client.send(operation: "GetBot", path: "/bots/{name}/versions/{versionoralias}", httpMethod: "GET", input: input)
    }
    ...
    public func getBotAlias(_ input: GetBotAliasRequest) -> EventLoopFuture<GetBotAliasResponse> {
        return client.send(operation: "GetBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: "GET", input: input)
    }
    ...
    public func getBotAliases(_ input: GetBotAliasesRequest) -> EventLoopFuture<GetBotAliasesResponse> {
        return client.send(operation: "GetBotAliases", path: "/bots/{botName}/aliases/", httpMethod: "GET", input: input)
    }
    ...
    public func getBotChannelAssociation(_ input: GetBotChannelAssociationRequest) -> EventLoopFuture<GetBotChannelAssociationResponse> {
        return client.send(operation: "GetBotChannelAssociation", path: "/bots/{botName}/aliases/{aliasName}/channels/{name}", httpMethod: "GET", input: input)
    }
    ...
    public func getBotChannelAssociations(_ input: GetBotChannelAssociationsRequest) -> EventLoopFuture<GetBotChannelAssociationsResponse> {
        return client.send(operation: "GetBotChannelAssociations", path: "/bots/{botName}/aliases/{aliasName}/channels/", httpMethod: "GET", input: input)
    }
    ...
    public func getBotVersions(_ input: GetBotVersionsRequest) -> EventLoopFuture<GetBotVersionsResponse> {
        return client.send(operation: "GetBotVersions", path: "/bots/{name}/versions/", httpMethod: "GET", input: input)
    }
    ...
    public func getBots(_ input: GetBotsRequest) -> EventLoopFuture<GetBotsResponse> {
        return client.send(operation: "GetBots", path: "/bots/", httpMethod: "GET", input: input)
    }

    ///  Returns information about a built-in intent. This operation requires permission for the lex:GetBuiltinIntent action.
    public func getBuiltinIntent(_ input: GetBuiltinIntentRequest) -> EventLoopFuture<GetBuiltinIntentResponse> {
        return client.send(operation: "GetBuiltinIntent", path: "/builtins/intents/{signature}", httpMethod: "GET", input: input)
    }
    ...
    public func getBuiltinIntents(_ input: GetBuiltinIntentsRequest) -> EventLoopFuture<GetBuiltinIntentsResponse> {
        return client.send(operation: "GetBuiltinIntents", path: "/builtins/intents/", httpMethod: "GET", input: input)
    }
    ...
    public func getBuiltinSlotTypes(_ input: GetBuiltinSlotTypesRequest) -> EventLoopFuture<GetBuiltinSlotTypesResponse> {
        return client.send(operation: "GetBuiltinSlotTypes", path: "/builtins/slottypes/", httpMethod: "GET", input: input)
    }

    ///  Exports the contents of a Amazon Lex resource in a specified format. 
    public func getExport(_ input: GetExportRequest) -> EventLoopFuture<GetExportResponse> {
        return client.send(operation: "GetExport", path: "/exports/", httpMethod: "GET", input: input)
    }

    ///  Gets information about an import job started with the StartImport operation.
    public func getImport(_ input: GetImportRequest) -> EventLoopFuture<GetImportResponse> {
        return client.send(operation: "GetImport", path: "/imports/{importId}", httpMethod: "GET", input: input)
    }
    ...
    public func getIntent(_ input: GetIntentRequest) -> EventLoopFuture<GetIntentResponse> {
        return client.send(operation: "GetIntent", path: "/intents/{name}/versions/{version}", httpMethod: "GET", input: input)
    }
    ...
    public func getIntentVersions(_ input: GetIntentVersionsRequest) -> EventLoopFuture<GetIntentVersionsResponse> {
        return client.send(operation: "GetIntentVersions", path: "/intents/{name}/versions/", httpMethod: "GET", input: input)
    }
    ...
    public func getIntents(_ input: GetIntentsRequest) -> EventLoopFuture<GetIntentsResponse> {
        return client.send(operation: "GetIntents", path: "/intents/", httpMethod: "GET", input: input)
    }
    ...
    public func getSlotType(_ input: GetSlotTypeRequest) -> EventLoopFuture<GetSlotTypeResponse> {
        return client.send(operation: "GetSlotType", path: "/slottypes/{name}/versions/{version}", httpMethod: "GET", input: input)
    }
    ...
    public func getSlotTypeVersions(_ input: GetSlotTypeVersionsRequest) -> EventLoopFuture<GetSlotTypeVersionsResponse> {
        return client.send(operation: "GetSlotTypeVersions", path: "/slottypes/{name}/versions/", httpMethod: "GET", input: input)
    }
    ...
    public func getSlotTypes(_ input: GetSlotTypesRequest) -> EventLoopFuture<GetSlotTypesResponse> {
        return client.send(operation: "GetSlotTypes", path: "/slottypes/", httpMethod: "GET", input: input)
    }
    ...
    public func getUtterancesView(_ input: GetUtterancesViewRequest) -> EventLoopFuture<GetUtterancesViewResponse> {
        return client.send(operation: "GetUtterancesView", path: "/bots/{botname}/utterances?view=aggregation", httpMethod: "GET", input: input)
    }
    ...
    public func putBot(_ input: PutBotRequest) -> EventLoopFuture<PutBotResponse> {
        return client.send(operation: "PutBot", path: "/bots/{name}/versions/$LATEST", httpMethod: "PUT", input: input)
    }
    ...
    public func putBotAlias(_ input: PutBotAliasRequest) -> EventLoopFuture<PutBotAliasResponse> {
        return client.send(operation: "PutBotAlias", path: "/bots/{botName}/aliases/{name}", httpMethod: "PUT", input: input)
    }
    ...
    public func putIntent(_ input: PutIntentRequest) -> EventLoopFuture<PutIntentResponse> {
        return client.send(operation: "PutIntent", path: "/intents/{name}/versions/$LATEST", httpMethod: "PUT", input: input)
    }
    ...
    public func putSlotType(_ input: PutSlotTypeRequest) -> EventLoopFuture<PutSlotTypeResponse> {
        return client.send(operation: "PutSlotType", path: "/slottypes/{name}/versions/$LATEST", httpMethod: "PUT", input: input)
    }

    ///  Starts a job to import a resource to Amazon Lex.
    public func startImport(_ input: StartImportRequest) -> EventLoopFuture<StartImportResponse> {
        return client.send(operation: "StartImport", path: "/imports/", httpMethod: "POST", input: input)
    }
}
