...
public struct EC2 {
    ...
    public func acceptTransitGatewayPeeringAttachment(_ input: AcceptTransitGatewayPeeringAttachmentRequest) -> EventLoopFuture<AcceptTransitGatewayPeeringAttachmentResult> {
        return client.send(operation: "AcceptTransitGatewayPeeringAttachment", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func acceptTransitGatewayVpcAttachment(_ input: AcceptTransitGatewayVpcAttachmentRequest) -> EventLoopFuture<AcceptTransitGatewayVpcAttachmentResult> {
        return client.send(operation: "AcceptTransitGatewayVpcAttachment", path: "/", httpMethod: "POST", input: input)
    }

    ///  Accepts one or more interface VPC endpoint connection requests to your VPC endpoint service.
    public func acceptVpcEndpointConnections(_ input: AcceptVpcEndpointConnectionsRequest) -> EventLoopFuture<AcceptVpcEndpointConnectionsResult> {
    ...
    public func acceptVpcPeeringConnection(_ input: AcceptVpcPeeringConnectionRequest) -> EventLoopFuture<AcceptVpcPeeringConnectionResult> {
    ...
    public func allocateAddress(_ input: AllocateAddressRequest) -> EventLoopFuture<AllocateAddressResult> {
        return client.send(operation: "AllocateAddress", path: "/", httpMethod: "POST", input: input)
    }

    ///  Allocates a Dedicated Host to your account. At a minimum, specify the supported instance type or instance family, the Availability Zone in which to allocate the host, and the number of hosts to allocate.
    public func allocateHosts(_ input: AllocateHostsRequest) -> EventLoopFuture<AllocateHostsResult> {
        return client.send(operation: "AllocateHosts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Applies a security group to the association between the target network and the Client VPN endpoint. This action replaces the existing security groups with the specified security groups.
    public func applySecurityGroupsToClientVpnTargetNetwork(_ input: ApplySecurityGroupsToClientVpnTargetNetworkRequest) -> EventLoopFuture<ApplySecurityGroupsToClientVpnTargetNetworkResult> {
    ...
    public func assignIpv6Addresses(_ input: AssignIpv6AddressesRequest) -> EventLoopFuture<AssignIpv6AddressesResult> {
    ...
    public func assignPrivateIpAddresses(_ input: AssignPrivateIpAddressesRequest) -> EventLoopFuture<AssignPrivateIpAddressesResult> {
    ...
    public func associateAddress(_ input: AssociateAddressRequest) -> EventLoopFuture<AssociateAddressResult> {
    ...
    public func associateClientVpnTargetNetwork(_ input: AssociateClientVpnTargetNetworkRequest) -> EventLoopFuture<AssociateClientVpnTargetNetworkResult> {
    ...
    @discardableResult public func associateDhcpOptions(_ input: AssociateDhcpOptionsRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "AssociateDhcpOptions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates an IAM instance profile with a running or stopped instance. You cannot associate more than one IAM instance profile with an instance.
    public func associateIamInstanceProfile(_ input: AssociateIamInstanceProfileRequest) -> EventLoopFuture<AssociateIamInstanceProfileResult> {
    ...
    public func associateRouteTable(_ input: AssociateRouteTableRequest) -> EventLoopFuture<AssociateRouteTableResult> {
        return client.send(operation: "AssociateRouteTable", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates a CIDR block with your subnet. You can only associate a single IPv6 CIDR block with your subnet. An IPv6 CIDR block must have a prefix length of /64.
    public func associateSubnetCidrBlock(_ input: AssociateSubnetCidrBlockRequest) -> EventLoopFuture<AssociateSubnetCidrBlockResult> {
    ...
    public func associateTransitGatewayMulticastDomain(_ input: AssociateTransitGatewayMulticastDomainRequest) -> EventLoopFuture<AssociateTransitGatewayMulticastDomainResult> {
        return client.send(operation: "AssociateTransitGatewayMulticastDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates the specified attachment with the specified transit gateway route table. You can associate only one route table with an attachment.
    public func associateTransitGatewayRouteTable(_ input: AssociateTransitGatewayRouteTableRequest) -> EventLoopFuture<AssociateTransitGatewayRouteTableResult> {
    ...
    public func attachClassicLinkVpc(_ input: AttachClassicLinkVpcRequest) -> EventLoopFuture<AttachClassicLinkVpcResult> {
    ...
    @discardableResult public func attachInternetGateway(_ input: AttachInternetGatewayRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "AttachInternetGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Attaches a network interface to an instance.
    public func attachNetworkInterface(_ input: AttachNetworkInterfaceRequest) -> EventLoopFuture<AttachNetworkInterfaceResult> {
    ...
    public func attachVolume(_ input: AttachVolumeRequest) -> EventLoopFuture<VolumeAttachment> {
    ...
    public func attachVpnGateway(_ input: AttachVpnGatewayRequest) -> EventLoopFuture<AttachVpnGatewayResult> {
    ...
    public func authorizeClientVpnIngress(_ input: AuthorizeClientVpnIngressRequest) -> EventLoopFuture<AuthorizeClientVpnIngressResult> {
    ...
    @discardableResult public func authorizeSecurityGroupEgress(_ input: AuthorizeSecurityGroupEgressRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func authorizeSecurityGroupIngress(_ input: AuthorizeSecurityGroupIngressRequest) -> EventLoopFuture<Void> {
    ...
    public func bundleInstance(_ input: BundleInstanceRequest) -> EventLoopFuture<BundleInstanceResult> {
        return client.send(operation: "BundleInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels a bundling operation for an instance store-backed Windows instance.
    public func cancelBundleTask(_ input: CancelBundleTaskRequest) -> EventLoopFuture<CancelBundleTaskResult> {
    ...
    public func cancelCapacityReservation(_ input: CancelCapacityReservationRequest) -> EventLoopFuture<CancelCapacityReservationResult> {
    ...
    @discardableResult public func cancelConversionTask(_ input: CancelConversionRequest) -> EventLoopFuture<Void> {
    ...
    public func cancelImportTask(_ input: CancelImportTaskRequest) -> EventLoopFuture<CancelImportTaskResult> {
    ...
    public func cancelReservedInstancesListing(_ input: CancelReservedInstancesListingRequest) -> EventLoopFuture<CancelReservedInstancesListingResult> {
    ...
    public func cancelSpotFleetRequests(_ input: CancelSpotFleetRequestsRequest) -> EventLoopFuture<CancelSpotFleetRequestsResponse> {
    ...
    public func cancelSpotInstanceRequests(_ input: CancelSpotInstanceRequestsRequest) -> EventLoopFuture<CancelSpotInstanceRequestsResult> {
    ...
    public func confirmProductInstance(_ input: ConfirmProductInstanceRequest) -> EventLoopFuture<ConfirmProductInstanceResult> {
        return client.send(operation: "ConfirmProductInstance", path: "/", httpMethod: "POST", input: input)
    }

    ///  Copies the specified Amazon FPGA Image (AFI) to the current Region.
    public func copyFpgaImage(_ input: CopyFpgaImageRequest) -> EventLoopFuture<CopyFpgaImageResult> {
    ...
    public func copyImage(_ input: CopyImageRequest) -> EventLoopFuture<CopyImageResult> {
    ...
    public func createCapacityReservation(_ input: CreateCapacityReservationRequest) -> EventLoopFuture<CreateCapacityReservationResult> {
    ...
    public func createClientVpnEndpoint(_ input: CreateClientVpnEndpointRequest) -> EventLoopFuture<CreateClientVpnEndpointResult> {
    ...
    public func createClientVpnRoute(_ input: CreateClientVpnRouteRequest) -> EventLoopFuture<CreateClientVpnRouteResult> {
    ...
    public func createCustomerGateway(_ input: CreateCustomerGatewayRequest) -> EventLoopFuture<CreateCustomerGatewayResult> {
    ...
    public func createDefaultSubnet(_ input: CreateDefaultSubnetRequest) -> EventLoopFuture<CreateDefaultSubnetResult> {
    ...
    public func createDefaultVpc(_ input: CreateDefaultVpcRequest) -> EventLoopFuture<CreateDefaultVpcResult> {
    ...
    public func createDhcpOptions(_ input: CreateDhcpOptionsRequest) -> EventLoopFuture<CreateDhcpOptionsResult> {
    ...
    public func createEgressOnlyInternetGateway(_ input: CreateEgressOnlyInternetGatewayRequest) -> EventLoopFuture<CreateEgressOnlyInternetGatewayResult> {
    ...
    public func createFlowLogs(_ input: CreateFlowLogsRequest) -> EventLoopFuture<CreateFlowLogsResult> {
    ...
    public func createFpgaImage(_ input: CreateFpgaImageRequest) -> EventLoopFuture<CreateFpgaImageResult> {
    ...
    public func createImage(_ input: CreateImageRequest) -> EventLoopFuture<CreateImageResult> {
    ...
    public func createInstanceExportTask(_ input: CreateInstanceExportTaskRequest) -> EventLoopFuture<CreateInstanceExportTaskResult> {
    ...
    public func createInternetGateway(_ input: CreateInternetGatewayRequest) -> EventLoopFuture<CreateInternetGatewayResult> {
    ...
    public func createKeyPair(_ input: CreateKeyPairRequest) -> EventLoopFuture<KeyPair> {
    ...
    public func createLaunchTemplate(_ input: CreateLaunchTemplateRequest) -> EventLoopFuture<CreateLaunchTemplateResult> {
    ...
    public func createLaunchTemplateVersion(_ input: CreateLaunchTemplateVersionRequest) -> EventLoopFuture<CreateLaunchTemplateVersionResult> {
        return client.send(operation: "CreateLaunchTemplateVersion", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a static route for the specified local gateway route table.
    public func createLocalGatewayRoute(_ input: CreateLocalGatewayRouteRequest) -> EventLoopFuture<CreateLocalGatewayRouteResult> {
        return client.send(operation: "CreateLocalGatewayRoute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Associates the specified VPC with the specified local gateway route table.
    public func createLocalGatewayRouteTableVpcAssociation(_ input: CreateLocalGatewayRouteTableVpcAssociationRequest) -> EventLoopFuture<CreateLocalGatewayRouteTableVpcAssociationResult> {
        return client.send(operation: "CreateLocalGatewayRouteTableVpcAssociation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a NAT gateway in the specified public subnet. This action creates a network interface in the specified subnet with a private IP address from the IP address range of the subnet. Internet-bound traffic from a private subnet can be routed to the NAT gateway, therefore enabling instances in the private subnet to connect to the internet. For more information, see NAT Gateways in the Amazon Virtual Private Cloud User Guide.
    public func createNatGateway(_ input: CreateNatGatewayRequest) -> EventLoopFuture<CreateNatGatewayResult> {
    ...
    public func createNetworkAcl(_ input: CreateNetworkAclRequest) -> EventLoopFuture<CreateNetworkAclResult> {
    ...
    @discardableResult public func createNetworkAclEntry(_ input: CreateNetworkAclEntryRequest) -> EventLoopFuture<Void> {
    ...
    public func createNetworkInterface(_ input: CreateNetworkInterfaceRequest) -> EventLoopFuture<CreateNetworkInterfaceResult> {
    ...
    public func createNetworkInterfacePermission(_ input: CreateNetworkInterfacePermissionRequest) -> EventLoopFuture<CreateNetworkInterfacePermissionResult> {
    ...
    public func createReservedInstancesListing(_ input: CreateReservedInstancesListingRequest) -> EventLoopFuture<CreateReservedInstancesListingResult> {
    ...
    public func createRouteTable(_ input: CreateRouteTableRequest) -> EventLoopFuture<CreateRouteTableResult> {
    ...
    public func createSecurityGroup(_ input: CreateSecurityGroupRequest) -> EventLoopFuture<CreateSecurityGroupResult> {
    ...
    public func createSnapshot(_ input: CreateSnapshotRequest) -> EventLoopFuture<Snapshot> {
    ...
    public func createSnapshots(_ input: CreateSnapshotsRequest) -> EventLoopFuture<CreateSnapshotsResult> {
    ...
    public func createSpotDatafeedSubscription(_ input: CreateSpotDatafeedSubscriptionRequest) -> EventLoopFuture<CreateSpotDatafeedSubscriptionResult> {
    ...
    public func createSubnet(_ input: CreateSubnetRequest) -> EventLoopFuture<CreateSubnetResult> {
    ...
    public func createTrafficMirrorFilter(_ input: CreateTrafficMirrorFilterRequest) -> EventLoopFuture<CreateTrafficMirrorFilterResult> {
    ...
    public func createTrafficMirrorFilterRule(_ input: CreateTrafficMirrorFilterRuleRequest) -> EventLoopFuture<CreateTrafficMirrorFilterRuleResult> {
    ...
    public func createTrafficMirrorSession(_ input: CreateTrafficMirrorSessionRequest) -> EventLoopFuture<CreateTrafficMirrorSessionResult> {
    ...
    public func createTrafficMirrorTarget(_ input: CreateTrafficMirrorTargetRequest) -> EventLoopFuture<CreateTrafficMirrorTargetResult> {
    ...
    public func createTransitGateway(_ input: CreateTransitGatewayRequest) -> EventLoopFuture<CreateTransitGatewayResult> {
    ...
    public func createTransitGatewayMulticastDomain(_ input: CreateTransitGatewayMulticastDomainRequest) -> EventLoopFuture<CreateTransitGatewayMulticastDomainResult> {
        return client.send(operation: "CreateTransitGatewayMulticastDomain", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createTransitGatewayPeeringAttachment(_ input: CreateTransitGatewayPeeringAttachmentRequest) -> EventLoopFuture<CreateTransitGatewayPeeringAttachmentResult> {
        return client.send(operation: "CreateTransitGatewayPeeringAttachment", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a static route for the specified transit gateway route table.
    public func createTransitGatewayRoute(_ input: CreateTransitGatewayRouteRequest) -> EventLoopFuture<CreateTransitGatewayRouteResult> {
        return client.send(operation: "CreateTransitGatewayRoute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Creates a route table for the specified transit gateway.
    public func createTransitGatewayRouteTable(_ input: CreateTransitGatewayRouteTableRequest) -> EventLoopFuture<CreateTransitGatewayRouteTableResult> {
    ...
    public func createTransitGatewayVpcAttachment(_ input: CreateTransitGatewayVpcAttachmentRequest) -> EventLoopFuture<CreateTransitGatewayVpcAttachmentResult> {
    ...
    public func createVolume(_ input: CreateVolumeRequest) -> EventLoopFuture<Volume> {
    ...
    public func createVpcEndpoint(_ input: CreateVpcEndpointRequest) -> EventLoopFuture<CreateVpcEndpointResult> {
    ...
    public func createVpcEndpointConnectionNotification(_ input: CreateVpcEndpointConnectionNotificationRequest) -> EventLoopFuture<CreateVpcEndpointConnectionNotificationResult> {
    ...
    public func createVpcEndpointServiceConfiguration(_ input: CreateVpcEndpointServiceConfigurationRequest) -> EventLoopFuture<CreateVpcEndpointServiceConfigurationResult> {
    ...
    public func createVpcPeeringConnection(_ input: CreateVpcPeeringConnectionRequest) -> EventLoopFuture<CreateVpcPeeringConnectionResult> {
    ...
    public func createVpnConnection(_ input: CreateVpnConnectionRequest) -> EventLoopFuture<CreateVpnConnectionResult> {
    ...
    @discardableResult public func createVpnConnectionRoute(_ input: CreateVpnConnectionRouteRequest) -> EventLoopFuture<Void> {
    ...
    public func createVpnGateway(_ input: CreateVpnGatewayRequest) -> EventLoopFuture<CreateVpnGatewayResult> {
        return client.send(operation: "CreateVpnGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified Client VPN endpoint. You must disassociate all target networks before you can delete a Client VPN endpoint.
    public func deleteClientVpnEndpoint(_ input: DeleteClientVpnEndpointRequest) -> EventLoopFuture<DeleteClientVpnEndpointResult> {
    ...
    public func deleteClientVpnRoute(_ input: DeleteClientVpnRouteRequest) -> EventLoopFuture<DeleteClientVpnRouteResult> {
        return client.send(operation: "DeleteClientVpnRoute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified customer gateway. You must delete the VPN connection before you can delete the customer gateway.
    @discardableResult public func deleteCustomerGateway(_ input: DeleteCustomerGatewayRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteDhcpOptions(_ input: DeleteDhcpOptionsRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteDhcpOptions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes an egress-only internet gateway.
    public func deleteEgressOnlyInternetGateway(_ input: DeleteEgressOnlyInternetGatewayRequest) -> EventLoopFuture<DeleteEgressOnlyInternetGatewayResult> {
    ...
    public func deleteFleets(_ input: DeleteFleetsRequest) -> EventLoopFuture<DeleteFleetsResult> {
        return client.send(operation: "DeleteFleets", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes one or more flow logs.
    public func deleteFlowLogs(_ input: DeleteFlowLogsRequest) -> EventLoopFuture<DeleteFlowLogsResult> {
        return client.send(operation: "DeleteFlowLogs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified Amazon FPGA Image (AFI).
    public func deleteFpgaImage(_ input: DeleteFpgaImageRequest) -> EventLoopFuture<DeleteFpgaImageResult> {
        return client.send(operation: "DeleteFpgaImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified internet gateway. You must detach the internet gateway from the VPC before you can delete it.
    @discardableResult public func deleteInternetGateway(_ input: DeleteInternetGatewayRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteInternetGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified key pair, by removing the public key from Amazon EC2.
    @discardableResult public func deleteKeyPair(_ input: DeleteKeyPairRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteKeyPair", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a launch template. Deleting a launch template deletes all of its versions.
    public func deleteLaunchTemplate(_ input: DeleteLaunchTemplateRequest) -> EventLoopFuture<DeleteLaunchTemplateResult> {
    ...
    public func deleteLaunchTemplateVersions(_ input: DeleteLaunchTemplateVersionsRequest) -> EventLoopFuture<DeleteLaunchTemplateVersionsResult> {
        return client.send(operation: "DeleteLaunchTemplateVersions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified route from the specified local gateway route table.
    public func deleteLocalGatewayRoute(_ input: DeleteLocalGatewayRouteRequest) -> EventLoopFuture<DeleteLocalGatewayRouteResult> {
        return client.send(operation: "DeleteLocalGatewayRoute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified association between a VPC and local gateway route table.
    public func deleteLocalGatewayRouteTableVpcAssociation(_ input: DeleteLocalGatewayRouteTableVpcAssociationRequest) -> EventLoopFuture<DeleteLocalGatewayRouteTableVpcAssociationResult> {
        return client.send(operation: "DeleteLocalGatewayRouteTableVpcAssociation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified NAT gateway. Deleting a NAT gateway disassociates its Elastic IP address, but does not release the address from your account. Deleting a NAT gateway does not delete any NAT gateway routes in your route tables.
    public func deleteNatGateway(_ input: DeleteNatGatewayRequest) -> EventLoopFuture<DeleteNatGatewayResult> {
        return client.send(operation: "DeleteNatGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified network ACL. You can't delete the ACL if it's associated with any subnets. You can't delete the default network ACL.
    @discardableResult public func deleteNetworkAcl(_ input: DeleteNetworkAclRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteNetworkAcl", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified ingress or egress entry (rule) from the specified network ACL.
    @discardableResult public func deleteNetworkAclEntry(_ input: DeleteNetworkAclEntryRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteNetworkAclEntry", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified network interface. You must detach the network interface before you can delete it.
    @discardableResult public func deleteNetworkInterface(_ input: DeleteNetworkInterfaceRequest) -> EventLoopFuture<Void> {
    ...
    public func deleteNetworkInterfacePermission(_ input: DeleteNetworkInterfacePermissionRequest) -> EventLoopFuture<DeleteNetworkInterfacePermissionResult> {
    ...
    @discardableResult public func deletePlacementGroup(_ input: DeletePlacementGroupRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeletePlacementGroup", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the queued purchases for the specified Reserved Instances.
    public func deleteQueuedReservedInstances(_ input: DeleteQueuedReservedInstancesRequest) -> EventLoopFuture<DeleteQueuedReservedInstancesResult> {
    ...
    @discardableResult public func deleteRouteTable(_ input: DeleteRouteTableRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteSecurityGroup(_ input: DeleteSecurityGroupRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteSnapshot(_ input: DeleteSnapshotRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteSnapshot", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the data feed for Spot Instances.
    @discardableResult public func deleteSpotDatafeedSubscription(_ input: DeleteSpotDatafeedSubscriptionRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteSpotDatafeedSubscription", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified subnet. You must terminate all running instances in the subnet before you can delete the subnet.
    @discardableResult public func deleteSubnet(_ input: DeleteSubnetRequest) -> EventLoopFuture<Void> {
    ...
    public func deleteTrafficMirrorFilter(_ input: DeleteTrafficMirrorFilterRequest) -> EventLoopFuture<DeleteTrafficMirrorFilterResult> {
        return client.send(operation: "DeleteTrafficMirrorFilter", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified Traffic Mirror rule.
    public func deleteTrafficMirrorFilterRule(_ input: DeleteTrafficMirrorFilterRuleRequest) -> EventLoopFuture<DeleteTrafficMirrorFilterRuleResult> {
        return client.send(operation: "DeleteTrafficMirrorFilterRule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified Traffic Mirror session.
    public func deleteTrafficMirrorSession(_ input: DeleteTrafficMirrorSessionRequest) -> EventLoopFuture<DeleteTrafficMirrorSessionResult> {
    ...
    public func deleteTrafficMirrorTarget(_ input: DeleteTrafficMirrorTargetRequest) -> EventLoopFuture<DeleteTrafficMirrorTargetResult> {
        return client.send(operation: "DeleteTrafficMirrorTarget", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified transit gateway.
    public func deleteTransitGateway(_ input: DeleteTransitGatewayRequest) -> EventLoopFuture<DeleteTransitGatewayResult> {
        return client.send(operation: "DeleteTransitGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified transit gateway multicast domain.
    public func deleteTransitGatewayMulticastDomain(_ input: DeleteTransitGatewayMulticastDomainRequest) -> EventLoopFuture<DeleteTransitGatewayMulticastDomainResult> {
        return client.send(operation: "DeleteTransitGatewayMulticastDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a transit gateway peering attachment.
    public func deleteTransitGatewayPeeringAttachment(_ input: DeleteTransitGatewayPeeringAttachmentRequest) -> EventLoopFuture<DeleteTransitGatewayPeeringAttachmentResult> {
        return client.send(operation: "DeleteTransitGatewayPeeringAttachment", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified route from the specified transit gateway route table.
    public func deleteTransitGatewayRoute(_ input: DeleteTransitGatewayRouteRequest) -> EventLoopFuture<DeleteTransitGatewayRouteResult> {
        return client.send(operation: "DeleteTransitGatewayRoute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified transit gateway route table. You must disassociate the route table from any transit gateway route tables before you can delete it.
    public func deleteTransitGatewayRouteTable(_ input: DeleteTransitGatewayRouteTableRequest) -> EventLoopFuture<DeleteTransitGatewayRouteTableResult> {
        return client.send(operation: "DeleteTransitGatewayRouteTable", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified VPC attachment.
    public func deleteTransitGatewayVpcAttachment(_ input: DeleteTransitGatewayVpcAttachmentRequest) -> EventLoopFuture<DeleteTransitGatewayVpcAttachmentResult> {
    ...
    @discardableResult public func deleteVolume(_ input: DeleteVolumeRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteVpc(_ input: DeleteVpcRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteVpc", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes one or more VPC endpoint connection notifications.
    public func deleteVpcEndpointConnectionNotifications(_ input: DeleteVpcEndpointConnectionNotificationsRequest) -> EventLoopFuture<DeleteVpcEndpointConnectionNotificationsResult> {
    ...
    public func deleteVpcEndpointServiceConfigurations(_ input: DeleteVpcEndpointServiceConfigurationsRequest) -> EventLoopFuture<DeleteVpcEndpointServiceConfigurationsResult> {
    ...
    public func deleteVpcEndpoints(_ input: DeleteVpcEndpointsRequest) -> EventLoopFuture<DeleteVpcEndpointsResult> {
    ...
    public func deleteVpcPeeringConnection(_ input: DeleteVpcPeeringConnectionRequest) -> EventLoopFuture<DeleteVpcPeeringConnectionResult> {
    ...
    @discardableResult public func deleteVpnConnection(_ input: DeleteVpnConnectionRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteVpnConnectionRoute(_ input: DeleteVpnConnectionRouteRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func deleteVpnGateway(_ input: DeleteVpnGatewayRequest) -> EventLoopFuture<Void> {
    ...
    public func deprovisionByoipCidr(_ input: DeprovisionByoipCidrRequest) -> EventLoopFuture<DeprovisionByoipCidrResult> {
    ...
    @discardableResult public func deregisterImage(_ input: DeregisterImageRequest) -> EventLoopFuture<Void> {
    ...
    public func deregisterTransitGatewayMulticastGroupSources(_ input: DeregisterTransitGatewayMulticastGroupSourcesRequest) -> EventLoopFuture<DeregisterTransitGatewayMulticastGroupSourcesResult> {
        return client.send(operation: "DeregisterTransitGatewayMulticastGroupSources", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeAccountAttributes(_ input: DescribeAccountAttributesRequest) -> EventLoopFuture<DescribeAccountAttributesResult> {
    ...
    public func describeAggregateIdFormat(_ input: DescribeAggregateIdFormatRequest) -> EventLoopFuture<DescribeAggregateIdFormatResult> {
    ...
    public func describeAvailabilityZones(_ input: DescribeAvailabilityZonesRequest) -> EventLoopFuture<DescribeAvailabilityZonesResult> {
    ...
    public func describeBundleTasks(_ input: DescribeBundleTasksRequest) -> EventLoopFuture<DescribeBundleTasksResult> {
    ...
    public func describeCapacityReservations(_ input: DescribeCapacityReservationsRequest) -> EventLoopFuture<DescribeCapacityReservationsResult> {
    ...
    public func describeClassicLinkInstances(_ input: DescribeClassicLinkInstancesRequest) -> EventLoopFuture<DescribeClassicLinkInstancesResult> {
        return client.send(operation: "DescribeClassicLinkInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the authorization rules for a specified Client VPN endpoint.
    public func describeClientVpnAuthorizationRules(_ input: DescribeClientVpnAuthorizationRulesRequest) -> EventLoopFuture<DescribeClientVpnAuthorizationRulesResult> {
    ...
    public func describeClientVpnConnections(_ input: DescribeClientVpnConnectionsRequest) -> EventLoopFuture<DescribeClientVpnConnectionsResult> {
        return client.send(operation: "DescribeClientVpnConnections", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more Client VPN endpoints in the account.
    public func describeClientVpnEndpoints(_ input: DescribeClientVpnEndpointsRequest) -> EventLoopFuture<DescribeClientVpnEndpointsResult> {
        return client.send(operation: "DescribeClientVpnEndpoints", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the routes for the specified Client VPN endpoint.
    public func describeClientVpnRoutes(_ input: DescribeClientVpnRoutesRequest) -> EventLoopFuture<DescribeClientVpnRoutesResult> {
        return client.send(operation: "DescribeClientVpnRoutes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the target networks associated with the specified Client VPN endpoint.
    public func describeClientVpnTargetNetworks(_ input: DescribeClientVpnTargetNetworksRequest) -> EventLoopFuture<DescribeClientVpnTargetNetworksResult> {
        return client.send(operation: "DescribeClientVpnTargetNetworks", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified customer-owned address pools or all of your customer-owned address pools.
    public func describeCoipPools(_ input: DescribeCoipPoolsRequest) -> EventLoopFuture<DescribeCoipPoolsResult> {
        return client.send(operation: "DescribeCoipPools", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeConversionTasks(_ input: DescribeConversionTasksRequest) -> EventLoopFuture<DescribeConversionTasksResult> {
    ...
    public func describeCustomerGateways(_ input: DescribeCustomerGatewaysRequest) -> EventLoopFuture<DescribeCustomerGatewaysResult> {
    ...
    public func describeDhcpOptions(_ input: DescribeDhcpOptionsRequest) -> EventLoopFuture<DescribeDhcpOptionsResult> {
        return client.send(operation: "DescribeDhcpOptions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your egress-only internet gateways.
    public func describeEgressOnlyInternetGateways(_ input: DescribeEgressOnlyInternetGatewaysRequest) -> EventLoopFuture<DescribeEgressOnlyInternetGatewaysResult> {
    ...
    public func describeElasticGpus(_ input: DescribeElasticGpusRequest) -> EventLoopFuture<DescribeElasticGpusResult> {
    ...
    public func describeExportImageTasks(_ input: DescribeExportImageTasksRequest) -> EventLoopFuture<DescribeExportImageTasksResult> {
    ...
    public func describeExportTasks(_ input: DescribeExportTasksRequest) -> EventLoopFuture<DescribeExportTasksResult> {
        return client.send(operation: "DescribeExportTasks", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the state of fast snapshot restores for your snapshots.
    public func describeFastSnapshotRestores(_ input: DescribeFastSnapshotRestoresRequest) -> EventLoopFuture<DescribeFastSnapshotRestoresResult> {
        return client.send(operation: "DescribeFastSnapshotRestores", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeFleetHistory(_ input: DescribeFleetHistoryRequest) -> EventLoopFuture<DescribeFleetHistoryResult> {
        return client.send(operation: "DescribeFleetHistory", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the running instances for the specified EC2 Fleet.
    public func describeFleetInstances(_ input: DescribeFleetInstancesRequest) -> EventLoopFuture<DescribeFleetInstancesResult> {
    ...
    public func describeFlowLogs(_ input: DescribeFlowLogsRequest) -> EventLoopFuture<DescribeFlowLogsResult> {
        return client.send(operation: "DescribeFlowLogs", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified attribute of the specified Amazon FPGA Image (AFI).
    public func describeFpgaImageAttribute(_ input: DescribeFpgaImageAttributeRequest) -> EventLoopFuture<DescribeFpgaImageAttributeResult> {
    ...
    public func describeFpgaImages(_ input: DescribeFpgaImagesRequest) -> EventLoopFuture<DescribeFpgaImagesResult> {
    ...
    public func describeHostReservationOfferings(_ input: DescribeHostReservationOfferingsRequest) -> EventLoopFuture<DescribeHostReservationOfferingsResult> {
        return client.send(operation: "DescribeHostReservationOfferings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes reservations that are associated with Dedicated Hosts in your account.
    public func describeHostReservations(_ input: DescribeHostReservationsRequest) -> EventLoopFuture<DescribeHostReservationsResult> {
    ...
    public func describeHosts(_ input: DescribeHostsRequest) -> EventLoopFuture<DescribeHostsResult> {
        return client.send(operation: "DescribeHosts", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes your IAM instance profile associations.
    public func describeIamInstanceProfileAssociations(_ input: DescribeIamInstanceProfileAssociationsRequest) -> EventLoopFuture<DescribeIamInstanceProfileAssociationsResult> {
    ...
    public func describeIdFormat(_ input: DescribeIdFormatRequest) -> EventLoopFuture<DescribeIdFormatResult> {
    ...
    public func describeIdentityIdFormat(_ input: DescribeIdentityIdFormatRequest) -> EventLoopFuture<DescribeIdentityIdFormatResult> {
        return client.send(operation: "DescribeIdentityIdFormat", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified attribute of the specified AMI. You can specify only one attribute at a time.
    public func describeImageAttribute(_ input: DescribeImageAttributeRequest) -> EventLoopFuture<ImageAttribute> {
    ...
    public func describeImportImageTasks(_ input: DescribeImportImageTasksRequest) -> EventLoopFuture<DescribeImportImageTasksResult> {
        return client.send(operation: "DescribeImportImageTasks", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes your import snapshot tasks.
    public func describeImportSnapshotTasks(_ input: DescribeImportSnapshotTasksRequest) -> EventLoopFuture<DescribeImportSnapshotTasksResult> {
    ...
    public func describeInstanceAttribute(_ input: DescribeInstanceAttributeRequest) -> EventLoopFuture<InstanceAttribute> {
    ...
    public func describeInstanceStatus(_ input: DescribeInstanceStatusRequest) -> EventLoopFuture<DescribeInstanceStatusResult> {
    ...
    public func describeInstanceTypeOfferings(_ input: DescribeInstanceTypeOfferingsRequest) -> EventLoopFuture<DescribeInstanceTypeOfferingsResult> {
        return client.send(operation: "DescribeInstanceTypeOfferings", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeInstanceTypes(_ input: DescribeInstanceTypesRequest) -> EventLoopFuture<DescribeInstanceTypesResult> {
        return client.send(operation: "DescribeInstanceTypes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeKeyPairs(_ input: DescribeKeyPairsRequest) -> EventLoopFuture<DescribeKeyPairsResult> {
    ...
    public func describeLaunchTemplateVersions(_ input: DescribeLaunchTemplateVersionsRequest) -> EventLoopFuture<DescribeLaunchTemplateVersionsResult> {
        return client.send(operation: "DescribeLaunchTemplateVersions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more launch templates.
    public func describeLaunchTemplates(_ input: DescribeLaunchTemplatesRequest) -> EventLoopFuture<DescribeLaunchTemplatesResult> {
        return client.send(operation: "DescribeLaunchTemplates", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the associations between virtual interface groups and local gateway route tables.
    public func describeLocalGatewayRouteTableVirtualInterfaceGroupAssociations(_ input: DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest) -> EventLoopFuture<DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsResult> {
        return client.send(operation: "DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified associations between VPCs and local gateway route tables.
    public func describeLocalGatewayRouteTableVpcAssociations(_ input: DescribeLocalGatewayRouteTableVpcAssociationsRequest) -> EventLoopFuture<DescribeLocalGatewayRouteTableVpcAssociationsResult> {
        return client.send(operation: "DescribeLocalGatewayRouteTableVpcAssociations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more local gateway route tables. By default, all local gateway route tables are described. Alternatively, you can filter the results.
    public func describeLocalGatewayRouteTables(_ input: DescribeLocalGatewayRouteTablesRequest) -> EventLoopFuture<DescribeLocalGatewayRouteTablesResult> {
        return client.send(operation: "DescribeLocalGatewayRouteTables", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified local gateway virtual interface groups.
    public func describeLocalGatewayVirtualInterfaceGroups(_ input: DescribeLocalGatewayVirtualInterfaceGroupsRequest) -> EventLoopFuture<DescribeLocalGatewayVirtualInterfaceGroupsResult> {
        return client.send(operation: "DescribeLocalGatewayVirtualInterfaceGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified local gateway virtual interfaces.
    public func describeLocalGatewayVirtualInterfaces(_ input: DescribeLocalGatewayVirtualInterfacesRequest) -> EventLoopFuture<DescribeLocalGatewayVirtualInterfacesResult> {
        return client.send(operation: "DescribeLocalGatewayVirtualInterfaces", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more local gateways. By default, all local gateways are described. Alternatively, you can filter the results.
    public func describeLocalGateways(_ input: DescribeLocalGatewaysRequest) -> EventLoopFuture<DescribeLocalGatewaysResult> {
        return client.send(operation: "DescribeLocalGateways", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes your Elastic IP addresses that are being moved to the EC2-VPC platform, or that are being restored to the EC2-Classic platform. This request does not return information about any other Elastic IP addresses in your account.
    public func describeMovingAddresses(_ input: DescribeMovingAddressesRequest) -> EventLoopFuture<DescribeMovingAddressesResult> {
        return client.send(operation: "DescribeMovingAddresses", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your NAT gateways.
    public func describeNatGateways(_ input: DescribeNatGatewaysRequest) -> EventLoopFuture<DescribeNatGatewaysResult> {
    ...
    public func describeNetworkAcls(_ input: DescribeNetworkAclsRequest) -> EventLoopFuture<DescribeNetworkAclsResult> {
        return client.send(operation: "DescribeNetworkAcls", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes a network interface attribute. You can specify only one attribute at a time.
    public func describeNetworkInterfaceAttribute(_ input: DescribeNetworkInterfaceAttributeRequest) -> EventLoopFuture<DescribeNetworkInterfaceAttributeResult> {
        return client.send(operation: "DescribeNetworkInterfaceAttribute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the permissions for your network interfaces. 
    public func describeNetworkInterfacePermissions(_ input: DescribeNetworkInterfacePermissionsRequest) -> EventLoopFuture<DescribeNetworkInterfacePermissionsResult> {
        return client.send(operation: "DescribeNetworkInterfacePermissions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your network interfaces.
    public func describeNetworkInterfaces(_ input: DescribeNetworkInterfacesRequest) -> EventLoopFuture<DescribeNetworkInterfacesResult> {
    ...
    public func describePlacementGroups(_ input: DescribePlacementGroupsRequest) -> EventLoopFuture<DescribePlacementGroupsResult> {
    ...
    public func describePrefixLists(_ input: DescribePrefixListsRequest) -> EventLoopFuture<DescribePrefixListsResult> {
    ...
    public func describePrincipalIdFormat(_ input: DescribePrincipalIdFormatRequest) -> EventLoopFuture<DescribePrincipalIdFormatResult> {
        return client.send(operation: "DescribePrincipalIdFormat", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified IPv4 address pools.
    public func describePublicIpv4Pools(_ input: DescribePublicIpv4PoolsRequest) -> EventLoopFuture<DescribePublicIpv4PoolsResult> {
    ...
    public func describeRegions(_ input: DescribeRegionsRequest) -> EventLoopFuture<DescribeRegionsResult> {
    ...
    public func describeReservedInstances(_ input: DescribeReservedInstancesRequest) -> EventLoopFuture<DescribeReservedInstancesResult> {
    ...
    public func describeReservedInstancesListings(_ input: DescribeReservedInstancesListingsRequest) -> EventLoopFuture<DescribeReservedInstancesListingsResult> {
    ...
    public func describeReservedInstancesModifications(_ input: DescribeReservedInstancesModificationsRequest) -> EventLoopFuture<DescribeReservedInstancesModificationsResult> {
    ...
    public func describeReservedInstancesOfferings(_ input: DescribeReservedInstancesOfferingsRequest) -> EventLoopFuture<DescribeReservedInstancesOfferingsResult> {
    ...
    public func describeRouteTables(_ input: DescribeRouteTablesRequest) -> EventLoopFuture<DescribeRouteTablesResult> {
    ...
    public func describeScheduledInstanceAvailability(_ input: DescribeScheduledInstanceAvailabilityRequest) -> EventLoopFuture<DescribeScheduledInstanceAvailabilityResult> {
        return client.send(operation: "DescribeScheduledInstanceAvailability", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified Scheduled Instances or all your Scheduled Instances.
    public func describeScheduledInstances(_ input: DescribeScheduledInstancesRequest) -> EventLoopFuture<DescribeScheduledInstancesResult> {
        return client.send(operation: "DescribeScheduledInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  [VPC only] Describes the VPCs on the other side of a VPC peering connection that are referencing the security groups you've specified in this request.
    public func describeSecurityGroupReferences(_ input: DescribeSecurityGroupReferencesRequest) -> EventLoopFuture<DescribeSecurityGroupReferencesResult> {
    ...
    public func describeSecurityGroups(_ input: DescribeSecurityGroupsRequest) -> EventLoopFuture<DescribeSecurityGroupsResult> {
    ...
    public func describeSnapshotAttribute(_ input: DescribeSnapshotAttributeRequest) -> EventLoopFuture<DescribeSnapshotAttributeResult> {
    ...
    public func describeSpotDatafeedSubscription(_ input: DescribeSpotDatafeedSubscriptionRequest) -> EventLoopFuture<DescribeSpotDatafeedSubscriptionResult> {
        return client.send(operation: "DescribeSpotDatafeedSubscription", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the running instances for the specified Spot Fleet.
    public func describeSpotFleetInstances(_ input: DescribeSpotFleetInstancesRequest) -> EventLoopFuture<DescribeSpotFleetInstancesResponse> {
    ...
    public func describeSpotFleetRequestHistory(_ input: DescribeSpotFleetRequestHistoryRequest) -> EventLoopFuture<DescribeSpotFleetRequestHistoryResponse> {
    ...
    public func describeSpotFleetRequests(_ input: DescribeSpotFleetRequestsRequest) -> EventLoopFuture<DescribeSpotFleetRequestsResponse> {
    ...
    public func describeSpotInstanceRequests(_ input: DescribeSpotInstanceRequestsRequest) -> EventLoopFuture<DescribeSpotInstanceRequestsResult> {
    ...
    public func describeSpotPriceHistory(_ input: DescribeSpotPriceHistoryRequest) -> EventLoopFuture<DescribeSpotPriceHistoryResult> {
    ...
    public func describeStaleSecurityGroups(_ input: DescribeStaleSecurityGroupsRequest) -> EventLoopFuture<DescribeStaleSecurityGroupsResult> {
    ...
    public func describeSubnets(_ input: DescribeSubnetsRequest) -> EventLoopFuture<DescribeSubnetsResult> {
    ...
    public func describeTrafficMirrorFilters(_ input: DescribeTrafficMirrorFiltersRequest) -> EventLoopFuture<DescribeTrafficMirrorFiltersResult> {
        return client.send(operation: "DescribeTrafficMirrorFilters", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more Traffic Mirror sessions. By default, all Traffic Mirror sessions are described. Alternatively, you can filter the results.
    public func describeTrafficMirrorSessions(_ input: DescribeTrafficMirrorSessionsRequest) -> EventLoopFuture<DescribeTrafficMirrorSessionsResult> {
        return client.send(operation: "DescribeTrafficMirrorSessions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Information about one or more Traffic Mirror targets.
    public func describeTrafficMirrorTargets(_ input: DescribeTrafficMirrorTargetsRequest) -> EventLoopFuture<DescribeTrafficMirrorTargetsResult> {
    ...
    public func describeTransitGatewayAttachments(_ input: DescribeTransitGatewayAttachmentsRequest) -> EventLoopFuture<DescribeTransitGatewayAttachmentsResult> {
        return client.send(operation: "DescribeTransitGatewayAttachments", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more transit gateway multicast domains.
    public func describeTransitGatewayMulticastDomains(_ input: DescribeTransitGatewayMulticastDomainsRequest) -> EventLoopFuture<DescribeTransitGatewayMulticastDomainsResult> {
        return client.send(operation: "DescribeTransitGatewayMulticastDomains", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes your transit gateway peering attachments.
    public func describeTransitGatewayPeeringAttachments(_ input: DescribeTransitGatewayPeeringAttachmentsRequest) -> EventLoopFuture<DescribeTransitGatewayPeeringAttachmentsResult> {
        return client.send(operation: "DescribeTransitGatewayPeeringAttachments", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more transit gateway route tables. By default, all transit gateway route tables are described. Alternatively, you can filter the results.
    public func describeTransitGatewayRouteTables(_ input: DescribeTransitGatewayRouteTablesRequest) -> EventLoopFuture<DescribeTransitGatewayRouteTablesResult> {
        return client.send(operation: "DescribeTransitGatewayRouteTables", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more VPC attachments. By default, all VPC attachments are described. Alternatively, you can filter the results.
    public func describeTransitGatewayVpcAttachments(_ input: DescribeTransitGatewayVpcAttachmentsRequest) -> EventLoopFuture<DescribeTransitGatewayVpcAttachmentsResult> {
    ...
    public func describeTransitGateways(_ input: DescribeTransitGatewaysRequest) -> EventLoopFuture<DescribeTransitGatewaysResult> {
    ...
    public func describeVolumeAttribute(_ input: DescribeVolumeAttributeRequest) -> EventLoopFuture<DescribeVolumeAttributeResult> {
    ...
    public func describeVolumeStatus(_ input: DescribeVolumeStatusRequest) -> EventLoopFuture<DescribeVolumeStatusResult> {
    ...
    public func describeVolumesModifications(_ input: DescribeVolumesModificationsRequest) -> EventLoopFuture<DescribeVolumesModificationsResult> {
        return client.send(operation: "DescribeVolumesModifications", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the specified attribute of the specified VPC. You can specify only one attribute at a time.
    public func describeVpcAttribute(_ input: DescribeVpcAttributeRequest) -> EventLoopFuture<DescribeVpcAttributeResult> {
        return client.send(operation: "DescribeVpcAttribute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the ClassicLink status of one or more VPCs.
    public func describeVpcClassicLink(_ input: DescribeVpcClassicLinkRequest) -> EventLoopFuture<DescribeVpcClassicLinkResult> {
    ...
    public func describeVpcClassicLinkDnsSupport(_ input: DescribeVpcClassicLinkDnsSupportRequest) -> EventLoopFuture<DescribeVpcClassicLinkDnsSupportResult> {
        return client.send(operation: "DescribeVpcClassicLinkDnsSupport", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the connection notifications for VPC endpoints and VPC endpoint services.
    public func describeVpcEndpointConnectionNotifications(_ input: DescribeVpcEndpointConnectionNotificationsRequest) -> EventLoopFuture<DescribeVpcEndpointConnectionNotificationsResult> {
    ...
    public func describeVpcEndpointConnections(_ input: DescribeVpcEndpointConnectionsRequest) -> EventLoopFuture<DescribeVpcEndpointConnectionsResult> {
        return client.send(operation: "DescribeVpcEndpointConnections", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the VPC endpoint service configurations in your account (your services).
    public func describeVpcEndpointServiceConfigurations(_ input: DescribeVpcEndpointServiceConfigurationsRequest) -> EventLoopFuture<DescribeVpcEndpointServiceConfigurationsResult> {
    ...
    public func describeVpcEndpointServicePermissions(_ input: DescribeVpcEndpointServicePermissionsRequest) -> EventLoopFuture<DescribeVpcEndpointServicePermissionsResult> {
        return client.send(operation: "DescribeVpcEndpointServicePermissions", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes available services to which you can create a VPC endpoint.
    public func describeVpcEndpointServices(_ input: DescribeVpcEndpointServicesRequest) -> EventLoopFuture<DescribeVpcEndpointServicesResult> {
        return client.send(operation: "DescribeVpcEndpointServices", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your VPC endpoints.
    public func describeVpcEndpoints(_ input: DescribeVpcEndpointsRequest) -> EventLoopFuture<DescribeVpcEndpointsResult> {
        return client.send(operation: "DescribeVpcEndpoints", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your VPC peering connections.
    public func describeVpcPeeringConnections(_ input: DescribeVpcPeeringConnectionsRequest) -> EventLoopFuture<DescribeVpcPeeringConnectionsResult> {
        return client.send(operation: "DescribeVpcPeeringConnections", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes one or more of your VPCs.
    public func describeVpcs(_ input: DescribeVpcsRequest) -> EventLoopFuture<DescribeVpcsResult> {
    ...
    public func describeVpnConnections(_ input: DescribeVpnConnectionsRequest) -> EventLoopFuture<DescribeVpnConnectionsResult> {
    ...
    public func describeVpnGateways(_ input: DescribeVpnGatewaysRequest) -> EventLoopFuture<DescribeVpnGatewaysResult> {
    ...
    public func detachClassicLinkVpc(_ input: DetachClassicLinkVpcRequest) -> EventLoopFuture<DetachClassicLinkVpcResult> {
        return client.send(operation: "DetachClassicLinkVpc", path: "/", httpMethod: "POST", input: input)
    }

    ///  Detaches an internet gateway from a VPC, disabling connectivity between the internet and the VPC. The VPC must not contain any running instances with Elastic IP addresses or public IPv4 addresses.
    @discardableResult public func detachInternetGateway(_ input: DetachInternetGatewayRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DetachInternetGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Detaches a network interface from an instance.
    @discardableResult public func detachNetworkInterface(_ input: DetachNetworkInterfaceRequest) -> EventLoopFuture<Void> {
    ...
    public func detachVolume(_ input: DetachVolumeRequest) -> EventLoopFuture<VolumeAttachment> {
    ...
    @discardableResult public func detachVpnGateway(_ input: DetachVpnGatewayRequest) -> EventLoopFuture<Void> {
    ...
    public func disableEbsEncryptionByDefault(_ input: DisableEbsEncryptionByDefaultRequest) -> EventLoopFuture<DisableEbsEncryptionByDefaultResult> {
        return client.send(operation: "DisableEbsEncryptionByDefault", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables fast snapshot restores for the specified snapshots in the specified Availability Zones.
    public func disableFastSnapshotRestores(_ input: DisableFastSnapshotRestoresRequest) -> EventLoopFuture<DisableFastSnapshotRestoresResult> {
        return client.send(operation: "DisableFastSnapshotRestores", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables the specified resource attachment from propagating routes to the specified propagation route table.
    public func disableTransitGatewayRouteTablePropagation(_ input: DisableTransitGatewayRouteTablePropagationRequest) -> EventLoopFuture<DisableTransitGatewayRouteTablePropagationResult> {
    ...
    @discardableResult public func disableVgwRoutePropagation(_ input: DisableVgwRoutePropagationRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "DisableVgwRoutePropagation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables ClassicLink for a VPC. You cannot disable ClassicLink for a VPC that has EC2-Classic instances linked to it.
    public func disableVpcClassicLink(_ input: DisableVpcClassicLinkRequest) -> EventLoopFuture<DisableVpcClassicLinkResult> {
    ...
    public func disableVpcClassicLinkDnsSupport(_ input: DisableVpcClassicLinkDnsSupportRequest) -> EventLoopFuture<DisableVpcClassicLinkDnsSupportResult> {
    ...
    @discardableResult public func disassociateAddress(_ input: DisassociateAddressRequest) -> EventLoopFuture<Void> {
    ...
    public func disassociateClientVpnTargetNetwork(_ input: DisassociateClientVpnTargetNetworkRequest) -> EventLoopFuture<DisassociateClientVpnTargetNetworkResult> {
    ...
    public func disassociateIamInstanceProfile(_ input: DisassociateIamInstanceProfileRequest) -> EventLoopFuture<DisassociateIamInstanceProfileResult> {
    ...
    @discardableResult public func disassociateRouteTable(_ input: DisassociateRouteTableRequest) -> EventLoopFuture<Void> {
    ...
    public func disassociateSubnetCidrBlock(_ input: DisassociateSubnetCidrBlockRequest) -> EventLoopFuture<DisassociateSubnetCidrBlockResult> {
        return client.send(operation: "DisassociateSubnetCidrBlock", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates the specified subnets from the transit gateway multicast domain. 
    public func disassociateTransitGatewayMulticastDomain(_ input: DisassociateTransitGatewayMulticastDomainRequest) -> EventLoopFuture<DisassociateTransitGatewayMulticastDomainResult> {
        return client.send(operation: "DisassociateTransitGatewayMulticastDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disassociates a resource attachment from a transit gateway route table.
    public func disassociateTransitGatewayRouteTable(_ input: DisassociateTransitGatewayRouteTableRequest) -> EventLoopFuture<DisassociateTransitGatewayRouteTableResult> {
    ...
    public func disassociateVpcCidrBlock(_ input: DisassociateVpcCidrBlockRequest) -> EventLoopFuture<DisassociateVpcCidrBlockResult> {
    ...
    public func enableEbsEncryptionByDefault(_ input: EnableEbsEncryptionByDefaultRequest) -> EventLoopFuture<EnableEbsEncryptionByDefaultResult> {
    ...
    public func enableFastSnapshotRestores(_ input: EnableFastSnapshotRestoresRequest) -> EventLoopFuture<EnableFastSnapshotRestoresResult> {
        return client.send(operation: "EnableFastSnapshotRestores", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables the specified attachment to propagate routes to the specified propagation route table.
    public func enableTransitGatewayRouteTablePropagation(_ input: EnableTransitGatewayRouteTablePropagationRequest) -> EventLoopFuture<EnableTransitGatewayRouteTablePropagationResult> {
    ...
    @discardableResult public func enableVgwRoutePropagation(_ input: EnableVgwRoutePropagationRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "EnableVgwRoutePropagation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables I/O operations for a volume that had I/O operations disabled because the data on the volume was potentially inconsistent.
    @discardableResult public func enableVolumeIO(_ input: EnableVolumeIORequest) -> EventLoopFuture<Void> {
    ...
    public func enableVpcClassicLink(_ input: EnableVpcClassicLinkRequest) -> EventLoopFuture<EnableVpcClassicLinkResult> {
        return client.send(operation: "EnableVpcClassicLink", path: "/", httpMethod: "POST", input: input)
    }

    ///  Enables a VPC to support DNS hostname resolution for ClassicLink. If enabled, the DNS hostname of a linked EC2-Classic instance resolves to its private IP address when addressed from an instance in the VPC to which it's linked. Similarly, the DNS hostname of an instance in a VPC resolves to its private IP address when addressed from a linked EC2-Classic instance. For more information, see ClassicLink in the Amazon Elastic Compute Cloud User Guide.
    public func enableVpcClassicLinkDnsSupport(_ input: EnableVpcClassicLinkDnsSupportRequest) -> EventLoopFuture<EnableVpcClassicLinkDnsSupportResult> {
        return client.send(operation: "EnableVpcClassicLinkDnsSupport", path: "/", httpMethod: "POST", input: input)
    }

    ///  Downloads the client certificate revocation list for the specified Client VPN endpoint.
    public func exportClientVpnClientCertificateRevocationList(_ input: ExportClientVpnClientCertificateRevocationListRequest) -> EventLoopFuture<ExportClientVpnClientCertificateRevocationListResult> {
    ...
    public func exportClientVpnClientConfiguration(_ input: ExportClientVpnClientConfigurationRequest) -> EventLoopFuture<ExportClientVpnClientConfigurationResult> {
    ...
    public func exportImage(_ input: ExportImageRequest) -> EventLoopFuture<ExportImageResult> {
        return client.send(operation: "ExportImage", path: "/", httpMethod: "POST", input: input)
    }

    ///  Exports routes from the specified transit gateway route table to the specified S3 bucket. By default, all routes are exported. Alternatively, you can filter by CIDR range.
    public func exportTransitGatewayRoutes(_ input: ExportTransitGatewayRoutesRequest) -> EventLoopFuture<ExportTransitGatewayRoutesResult> {
    ...
    public func getCoipPoolUsage(_ input: GetCoipPoolUsageRequest) -> EventLoopFuture<GetCoipPoolUsageResult> {
        return client.send(operation: "GetCoipPoolUsage", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getConsoleOutput(_ input: GetConsoleOutputRequest) -> EventLoopFuture<GetConsoleOutputResult> {
    ...
    public func getConsoleScreenshot(_ input: GetConsoleScreenshotRequest) -> EventLoopFuture<GetConsoleScreenshotResult> {
    ...
    public func getDefaultCreditSpecification(_ input: GetDefaultCreditSpecificationRequest) -> EventLoopFuture<GetDefaultCreditSpecificationResult> {
        return client.send(operation: "GetDefaultCreditSpecification", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getEbsDefaultKmsKeyId(_ input: GetEbsDefaultKmsKeyIdRequest) -> EventLoopFuture<GetEbsDefaultKmsKeyIdResult> {
    ...
    public func getEbsEncryptionByDefault(_ input: GetEbsEncryptionByDefaultRequest) -> EventLoopFuture<GetEbsEncryptionByDefaultResult> {
    ...
    public func getHostReservationPurchasePreview(_ input: GetHostReservationPurchasePreviewRequest) -> EventLoopFuture<GetHostReservationPurchasePreviewResult> {
        return client.send(operation: "GetHostReservationPurchasePreview", path: "/", httpMethod: "POST", input: input)
    }

    ///  Retrieves the configuration data of the specified instance. You can use this data to create a launch template.
    public func getLaunchTemplateData(_ input: GetLaunchTemplateDataRequest) -> EventLoopFuture<GetLaunchTemplateDataResult> {
    ...
    public func getPasswordData(_ input: GetPasswordDataRequest) -> EventLoopFuture<GetPasswordDataResult> {
    ...
    public func getReservedInstancesExchangeQuote(_ input: GetReservedInstancesExchangeQuoteRequest) -> EventLoopFuture<GetReservedInstancesExchangeQuoteResult> {
        return client.send(operation: "GetReservedInstancesExchangeQuote", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the route tables to which the specified resource attachment propagates routes.
    public func getTransitGatewayAttachmentPropagations(_ input: GetTransitGatewayAttachmentPropagationsRequest) -> EventLoopFuture<GetTransitGatewayAttachmentPropagationsResult> {
        return client.send(operation: "GetTransitGatewayAttachmentPropagations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the associations for the transit gateway multicast domain.
    public func getTransitGatewayMulticastDomainAssociations(_ input: GetTransitGatewayMulticastDomainAssociationsRequest) -> EventLoopFuture<GetTransitGatewayMulticastDomainAssociationsResult> {
        return client.send(operation: "GetTransitGatewayMulticastDomainAssociations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the associations for the specified transit gateway route table.
    public func getTransitGatewayRouteTableAssociations(_ input: GetTransitGatewayRouteTableAssociationsRequest) -> EventLoopFuture<GetTransitGatewayRouteTableAssociationsResult> {
        return client.send(operation: "GetTransitGatewayRouteTableAssociations", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets information about the route table propagations for the specified transit gateway route table.
    public func getTransitGatewayRouteTablePropagations(_ input: GetTransitGatewayRouteTablePropagationsRequest) -> EventLoopFuture<GetTransitGatewayRouteTablePropagationsResult> {
    ...
    public func importClientVpnClientCertificateRevocationList(_ input: ImportClientVpnClientCertificateRevocationListRequest) -> EventLoopFuture<ImportClientVpnClientCertificateRevocationListResult> {
    ...
    public func importImage(_ input: ImportImageRequest) -> EventLoopFuture<ImportImageResult> {
    ...
    public func importInstance(_ input: ImportInstanceRequest) -> EventLoopFuture<ImportInstanceResult> {
    ...
    public func importSnapshot(_ input: ImportSnapshotRequest) -> EventLoopFuture<ImportSnapshotResult> {
    ...
    public func importVolume(_ input: ImportVolumeRequest) -> EventLoopFuture<ImportVolumeResult> {
    ...
    public func modifyCapacityReservation(_ input: ModifyCapacityReservationRequest) -> EventLoopFuture<ModifyCapacityReservationResult> {
    ...
    public func modifyClientVpnEndpoint(_ input: ModifyClientVpnEndpointRequest) -> EventLoopFuture<ModifyClientVpnEndpointResult> {
    ...
    public func modifyDefaultCreditSpecification(_ input: ModifyDefaultCreditSpecificationRequest) -> EventLoopFuture<ModifyDefaultCreditSpecificationResult> {
        return client.send(operation: "ModifyDefaultCreditSpecification", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func modifyEbsDefaultKmsKeyId(_ input: ModifyEbsDefaultKmsKeyIdRequest) -> EventLoopFuture<ModifyEbsDefaultKmsKeyIdResult> {
    ...
    public func modifyFleet(_ input: ModifyFleetRequest) -> EventLoopFuture<ModifyFleetResult> {
        return client.send(operation: "ModifyFleet", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified attribute of the specified Amazon FPGA Image (AFI).
    public func modifyFpgaImageAttribute(_ input: ModifyFpgaImageAttributeRequest) -> EventLoopFuture<ModifyFpgaImageAttributeResult> {
    ...
    public func modifyHosts(_ input: ModifyHostsRequest) -> EventLoopFuture<ModifyHostsResult> {
    ...
    @discardableResult public func modifyIdFormat(_ input: ModifyIdFormatRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func modifyIdentityIdFormat(_ input: ModifyIdentityIdFormatRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func modifyImageAttribute(_ input: ModifyImageAttributeRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func modifyInstanceAttribute(_ input: ModifyInstanceAttributeRequest) -> EventLoopFuture<Void> {
    ...
    public func modifyInstanceCapacityReservationAttributes(_ input: ModifyInstanceCapacityReservationAttributesRequest) -> EventLoopFuture<ModifyInstanceCapacityReservationAttributesResult> {
    ...
    public func modifyInstanceCreditSpecification(_ input: ModifyInstanceCreditSpecificationRequest) -> EventLoopFuture<ModifyInstanceCreditSpecificationResult> {
        return client.send(operation: "ModifyInstanceCreditSpecification", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the start time for a scheduled Amazon EC2 instance event.
    public func modifyInstanceEventStartTime(_ input: ModifyInstanceEventStartTimeRequest) -> EventLoopFuture<ModifyInstanceEventStartTimeResult> {
    ...
    public func modifyInstanceMetadataOptions(_ input: ModifyInstanceMetadataOptionsRequest) -> EventLoopFuture<ModifyInstanceMetadataOptionsResult> {
        return client.send(operation: "ModifyInstanceMetadataOptions", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func modifyInstancePlacement(_ input: ModifyInstancePlacementRequest) -> EventLoopFuture<ModifyInstancePlacementResult> {
    ...
    public func modifyLaunchTemplate(_ input: ModifyLaunchTemplateRequest) -> EventLoopFuture<ModifyLaunchTemplateResult> {
        return client.send(operation: "ModifyLaunchTemplate", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified network interface attribute. You can specify only one attribute at a time. You can use this action to attach and detach security groups from an existing EC2 instance.
    @discardableResult public func modifyNetworkInterfaceAttribute(_ input: ModifyNetworkInterfaceAttributeRequest) -> EventLoopFuture<Void> {
    ...
    public func modifyReservedInstances(_ input: ModifyReservedInstancesRequest) -> EventLoopFuture<ModifyReservedInstancesResult> {
    ...
    @discardableResult public func modifySnapshotAttribute(_ input: ModifySnapshotAttributeRequest) -> EventLoopFuture<Void> {
    ...
    public func modifySpotFleetRequest(_ input: ModifySpotFleetRequestRequest) -> EventLoopFuture<ModifySpotFleetRequestResponse> {
        return client.send(operation: "ModifySpotFleetRequest", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies a subnet attribute. You can only modify one attribute at a time.
    @discardableResult public func modifySubnetAttribute(_ input: ModifySubnetAttributeRequest) -> EventLoopFuture<Void> {
    ...
    public func modifyTrafficMirrorFilterNetworkServices(_ input: ModifyTrafficMirrorFilterNetworkServicesRequest) -> EventLoopFuture<ModifyTrafficMirrorFilterNetworkServicesResult> {
    ...
    public func modifyTrafficMirrorFilterRule(_ input: ModifyTrafficMirrorFilterRuleRequest) -> EventLoopFuture<ModifyTrafficMirrorFilterRuleResult> {
        return client.send(operation: "ModifyTrafficMirrorFilterRule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies a Traffic Mirror session.
    public func modifyTrafficMirrorSession(_ input: ModifyTrafficMirrorSessionRequest) -> EventLoopFuture<ModifyTrafficMirrorSessionResult> {
        return client.send(operation: "ModifyTrafficMirrorSession", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified VPC attachment.
    public func modifyTransitGatewayVpcAttachment(_ input: ModifyTransitGatewayVpcAttachmentRequest) -> EventLoopFuture<ModifyTransitGatewayVpcAttachmentResult> {
    ...
    public func modifyVolume(_ input: ModifyVolumeRequest) -> EventLoopFuture<ModifyVolumeResult> {
    ...
    @discardableResult public func modifyVolumeAttribute(_ input: ModifyVolumeAttributeRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "ModifyVolumeAttribute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the specified attribute of the specified VPC.
    @discardableResult public func modifyVpcAttribute(_ input: ModifyVpcAttributeRequest) -> EventLoopFuture<Void> {
    ...
    public func modifyVpcEndpoint(_ input: ModifyVpcEndpointRequest) -> EventLoopFuture<ModifyVpcEndpointResult> {
        return client.send(operation: "ModifyVpcEndpoint", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies a connection notification for VPC endpoint or VPC endpoint service. You can change the SNS topic for the notification, or the events for which to be notified. 
    public func modifyVpcEndpointConnectionNotification(_ input: ModifyVpcEndpointConnectionNotificationRequest) -> EventLoopFuture<ModifyVpcEndpointConnectionNotificationResult> {
    ...
    public func modifyVpcEndpointServiceConfiguration(_ input: ModifyVpcEndpointServiceConfigurationRequest) -> EventLoopFuture<ModifyVpcEndpointServiceConfigurationResult> {
    ...
    public func modifyVpcEndpointServicePermissions(_ input: ModifyVpcEndpointServicePermissionsRequest) -> EventLoopFuture<ModifyVpcEndpointServicePermissionsResult> {
    ...
    public func modifyVpcPeeringConnectionOptions(_ input: ModifyVpcPeeringConnectionOptionsRequest) -> EventLoopFuture<ModifyVpcPeeringConnectionOptionsResult> {
    ...
    public func modifyVpcTenancy(_ input: ModifyVpcTenancyRequest) -> EventLoopFuture<ModifyVpcTenancyResult> {
    ...
    public func modifyVpnConnection(_ input: ModifyVpnConnectionRequest) -> EventLoopFuture<ModifyVpnConnectionResult> {
        return client.send(operation: "ModifyVpnConnection", path: "/", httpMethod: "POST", input: input)
    }

    ///  Modifies the VPN tunnel endpoint certificate.
    public func modifyVpnTunnelCertificate(_ input: ModifyVpnTunnelCertificateRequest) -> EventLoopFuture<ModifyVpnTunnelCertificateResult> {
    ...
    public func modifyVpnTunnelOptions(_ input: ModifyVpnTunnelOptionsRequest) -> EventLoopFuture<ModifyVpnTunnelOptionsResult> {
    ...
    public func monitorInstances(_ input: MonitorInstancesRequest) -> EventLoopFuture<MonitorInstancesResult> {
    ...
    public func moveAddressToVpc(_ input: MoveAddressToVpcRequest) -> EventLoopFuture<MoveAddressToVpcResult> {
    ...
    public func purchaseHostReservation(_ input: PurchaseHostReservationRequest) -> EventLoopFuture<PurchaseHostReservationResult> {
    ...
    public func purchaseReservedInstancesOffering(_ input: PurchaseReservedInstancesOfferingRequest) -> EventLoopFuture<PurchaseReservedInstancesOfferingResult> {
    ...
    public func purchaseScheduledInstances(_ input: PurchaseScheduledInstancesRequest) -> EventLoopFuture<PurchaseScheduledInstancesResult> {
    ...
    public func registerImage(_ input: RegisterImageRequest) -> EventLoopFuture<RegisterImageResult> {
    ...
    public func registerTransitGatewayMulticastGroupSources(_ input: RegisterTransitGatewayMulticastGroupSourcesRequest) -> EventLoopFuture<RegisterTransitGatewayMulticastGroupSourcesResult> {
        return client.send(operation: "RegisterTransitGatewayMulticastGroupSources", path: "/", httpMethod: "POST", input: input)
    }

    ///  Rejects a transit gateway peering attachment request.
    public func rejectTransitGatewayPeeringAttachment(_ input: RejectTransitGatewayPeeringAttachmentRequest) -> EventLoopFuture<RejectTransitGatewayPeeringAttachmentResult> {
        return client.send(operation: "RejectTransitGatewayPeeringAttachment", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func rejectTransitGatewayVpcAttachment(_ input: RejectTransitGatewayVpcAttachmentRequest) -> EventLoopFuture<RejectTransitGatewayVpcAttachmentResult> {
        return client.send(operation: "RejectTransitGatewayVpcAttachment", path: "/", httpMethod: "POST", input: input)
    }

    ///  Rejects one or more VPC endpoint connection requests to your VPC endpoint service.
    public func rejectVpcEndpointConnections(_ input: RejectVpcEndpointConnectionsRequest) -> EventLoopFuture<RejectVpcEndpointConnectionsResult> {
    ...
    public func rejectVpcPeeringConnection(_ input: RejectVpcPeeringConnectionRequest) -> EventLoopFuture<RejectVpcPeeringConnectionResult> {
    ...
    @discardableResult public func releaseAddress(_ input: ReleaseAddressRequest) -> EventLoopFuture<Void> {
    ...
    public func releaseHosts(_ input: ReleaseHostsRequest) -> EventLoopFuture<ReleaseHostsResult> {
    ...
    public func replaceIamInstanceProfileAssociation(_ input: ReplaceIamInstanceProfileAssociationRequest) -> EventLoopFuture<ReplaceIamInstanceProfileAssociationResult> {
    ...
    public func replaceNetworkAclAssociation(_ input: ReplaceNetworkAclAssociationRequest) -> EventLoopFuture<ReplaceNetworkAclAssociationResult> {
        return client.send(operation: "ReplaceNetworkAclAssociation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Replaces an entry (rule) in a network ACL. For more information, see Network ACLs in the Amazon Virtual Private Cloud User Guide.
    @discardableResult public func replaceNetworkAclEntry(_ input: ReplaceNetworkAclEntryRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func replaceRoute(_ input: ReplaceRouteRequest) -> EventLoopFuture<Void> {
    ...
    public func replaceRouteTableAssociation(_ input: ReplaceRouteTableAssociationRequest) -> EventLoopFuture<ReplaceRouteTableAssociationResult> {
        return client.send(operation: "ReplaceRouteTableAssociation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Replaces the specified route in the specified transit gateway route table.
    public func replaceTransitGatewayRoute(_ input: ReplaceTransitGatewayRouteRequest) -> EventLoopFuture<ReplaceTransitGatewayRouteResult> {
    ...
    @discardableResult public func reportInstanceStatus(_ input: ReportInstanceStatusRequest) -> EventLoopFuture<Void> {
    ...
    public func requestSpotFleet(_ input: RequestSpotFleetRequest) -> EventLoopFuture<RequestSpotFleetResponse> {
    ...
    public func requestSpotInstances(_ input: RequestSpotInstancesRequest) -> EventLoopFuture<RequestSpotInstancesResult> {
    ...
    public func resetEbsDefaultKmsKeyId(_ input: ResetEbsDefaultKmsKeyIdRequest) -> EventLoopFuture<ResetEbsDefaultKmsKeyIdResult> {
        return client.send(operation: "ResetEbsDefaultKmsKeyId", path: "/", httpMethod: "POST", input: input)
    }

    ///  Resets the specified attribute of the specified Amazon FPGA Image (AFI) to its default value. You can only reset the load permission attribute.
    public func resetFpgaImageAttribute(_ input: ResetFpgaImageAttributeRequest) -> EventLoopFuture<ResetFpgaImageAttributeResult> {
    ...
    @discardableResult public func resetImageAttribute(_ input: ResetImageAttributeRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func resetInstanceAttribute(_ input: ResetInstanceAttributeRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "ResetInstanceAttribute", path: "/", httpMethod: "POST", input: input)
    }

    ///  Resets a network interface attribute. You can specify only one attribute at a time.
    @discardableResult public func resetNetworkInterfaceAttribute(_ input: ResetNetworkInterfaceAttributeRequest) -> EventLoopFuture<Void> {
    ...
    @discardableResult public func resetSnapshotAttribute(_ input: ResetSnapshotAttributeRequest) -> EventLoopFuture<Void> {
    ...
    public func restoreAddressToClassic(_ input: RestoreAddressToClassicRequest) -> EventLoopFuture<RestoreAddressToClassicResult> {
        return client.send(operation: "RestoreAddressToClassic", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes an ingress authorization rule from a Client VPN endpoint. 
    public func revokeClientVpnIngress(_ input: RevokeClientVpnIngressRequest) -> EventLoopFuture<RevokeClientVpnIngressResult> {
    ...
    public func runScheduledInstances(_ input: RunScheduledInstancesRequest) -> EventLoopFuture<RunScheduledInstancesResult> {
        return client.send(operation: "RunScheduledInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Searches for routes in the specified local gateway route table.
    public func searchLocalGatewayRoutes(_ input: SearchLocalGatewayRoutesRequest) -> EventLoopFuture<SearchLocalGatewayRoutesResult> {
        return client.send(operation: "SearchLocalGatewayRoutes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Searches one or more transit gateway multicast groups and returns the group membership information.
    public func searchTransitGatewayMulticastGroups(_ input: SearchTransitGatewayMulticastGroupsRequest) -> EventLoopFuture<SearchTransitGatewayMulticastGroupsResult> {
        return client.send(operation: "SearchTransitGatewayMulticastGroups", path: "/", httpMethod: "POST", input: input)
    }

    ///  Searches for routes in the specified transit gateway route table.
    public func searchTransitGatewayRoutes(_ input: SearchTransitGatewayRoutesRequest) -> EventLoopFuture<SearchTransitGatewayRoutesResult> {
    ...
    @discardableResult public func sendDiagnosticInterrupt(_ input: SendDiagnosticInterruptRequest) -> EventLoopFuture<Void> {
    ...
    public func startInstances(_ input: StartInstancesRequest) -> EventLoopFuture<StartInstancesResult> {
    ...
    public func startVpcEndpointServicePrivateDnsVerification(_ input: StartVpcEndpointServicePrivateDnsVerificationRequest) -> EventLoopFuture<StartVpcEndpointServicePrivateDnsVerificationResult> {
        return client.send(operation: "StartVpcEndpointServicePrivateDnsVerification", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func stopInstances(_ input: StopInstancesRequest) -> EventLoopFuture<StopInstancesResult> {
        return client.send(operation: "StopInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Terminates active Client VPN endpoint connections. This action can be used to terminate a specific client connection, or up to five connections established by a specific user.
    public func terminateClientVpnConnections(_ input: TerminateClientVpnConnectionsRequest) -> EventLoopFuture<TerminateClientVpnConnectionsResult> {
    ...
    public func terminateInstances(_ input: TerminateInstancesRequest) -> EventLoopFuture<TerminateInstancesResult> {
        return client.send(operation: "TerminateInstances", path: "/", httpMethod: "POST", input: input)
    }

    ///  Unassigns one or more IPv6 addresses from a network interface.
    public func unassignIpv6Addresses(_ input: UnassignIpv6AddressesRequest) -> EventLoopFuture<UnassignIpv6AddressesResult> {
        return client.send(operation: "UnassignIpv6Addresses", path: "/", httpMethod: "POST", input: input)
    }

    ///  Unassigns one or more secondary private IP addresses from a network interface.
    @discardableResult public func unassignPrivateIpAddresses(_ input: UnassignPrivateIpAddressesRequest) -> EventLoopFuture<Void> {
        return client.send(operation: "UnassignPrivateIpAddresses", path: "/", httpMethod: "POST", input: input)
    }

    ///  Disables detailed monitoring for a running instance. For more information, see Monitoring Your Instances and Volumes in the Amazon Elastic Compute Cloud User Guide.
    public func unmonitorInstances(_ input: UnmonitorInstancesRequest) -> EventLoopFuture<UnmonitorInstancesResult> {
    ...
    public func updateSecurityGroupRuleDescriptionsEgress(_ input: UpdateSecurityGroupRuleDescriptionsEgressRequest) -> EventLoopFuture<UpdateSecurityGroupRuleDescriptionsEgressResult> {
    ...
    public func updateSecurityGroupRuleDescriptionsIngress(_ input: UpdateSecurityGroupRuleDescriptionsIngressRequest) -> EventLoopFuture<UpdateSecurityGroupRuleDescriptionsIngressResult> {
