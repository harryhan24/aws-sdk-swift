...
public struct StorageGateway {
    ...
    public func activateGateway(_ input: ActivateGatewayInput) -> EventLoopFuture<ActivateGatewayOutput> {
        return client.send(operation: "ActivateGateway", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func addCache(_ input: AddCacheInput) -> EventLoopFuture<AddCacheOutput> {
        return client.send(operation: "AddCache", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func addTagsToResource(_ input: AddTagsToResourceInput) -> EventLoopFuture<AddTagsToResourceOutput> {
    ...
    public func addUploadBuffer(_ input: AddUploadBufferInput) -> EventLoopFuture<AddUploadBufferOutput> {
        return client.send(operation: "AddUploadBuffer", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func addWorkingStorage(_ input: AddWorkingStorageInput) -> EventLoopFuture<AddWorkingStorageOutput> {
        return client.send(operation: "AddWorkingStorage", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func assignTapePool(_ input: AssignTapePoolInput) -> EventLoopFuture<AssignTapePoolOutput> {
        return client.send(operation: "AssignTapePool", path: "/", httpMethod: "POST", input: input)
    }

    ///  Connects a volume to an iSCSI connection and then attaches the volume to the specified gateway. Detaching and attaching a volume enables you to recover your data from one gateway to a different gateway without creating a snapshot. It also makes it easier to move your volumes from an on-premises gateway to a gateway hosted on an Amazon EC2 instance.
    public func attachVolume(_ input: AttachVolumeInput) -> EventLoopFuture<AttachVolumeOutput> {
        return client.send(operation: "AttachVolume", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels archiving of a virtual tape to the virtual tape shelf (VTS) after the archiving process is initiated. This operation is only supported in the tape gateway type.
    public func cancelArchival(_ input: CancelArchivalInput) -> EventLoopFuture<CancelArchivalOutput> {
        return client.send(operation: "CancelArchival", path: "/", httpMethod: "POST", input: input)
    }

    ///  Cancels retrieval of a virtual tape from the virtual tape shelf (VTS) to a gateway after the retrieval process is initiated. The virtual tape is returned to the VTS. This operation is only supported in the tape gateway type.
    public func cancelRetrieval(_ input: CancelRetrievalInput) -> EventLoopFuture<CancelRetrievalOutput> {
        return client.send(operation: "CancelRetrieval", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createCachediSCSIVolume(_ input: CreateCachediSCSIVolumeInput) -> EventLoopFuture<CreateCachediSCSIVolumeOutput> {
        return client.send(operation: "CreateCachediSCSIVolume", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createNFSFileShare(_ input: CreateNFSFileShareInput) -> EventLoopFuture<CreateNFSFileShareOutput> {
        return client.send(operation: "CreateNFSFileShare", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createSMBFileShare(_ input: CreateSMBFileShareInput) -> EventLoopFuture<CreateSMBFileShareOutput> {
        return client.send(operation: "CreateSMBFileShare", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createSnapshot(_ input: CreateSnapshotInput) -> EventLoopFuture<CreateSnapshotOutput> {
    ...
    public func createSnapshotFromVolumeRecoveryPoint(_ input: CreateSnapshotFromVolumeRecoveryPointInput) -> EventLoopFuture<CreateSnapshotFromVolumeRecoveryPointOutput> {
        return client.send(operation: "CreateSnapshotFromVolumeRecoveryPoint", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createStorediSCSIVolume(_ input: CreateStorediSCSIVolumeInput) -> EventLoopFuture<CreateStorediSCSIVolumeOutput> {
        return client.send(operation: "CreateStorediSCSIVolume", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createTapeWithBarcode(_ input: CreateTapeWithBarcodeInput) -> EventLoopFuture<CreateTapeWithBarcodeOutput> {
        return client.send(operation: "CreateTapeWithBarcode", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func createTapes(_ input: CreateTapesInput) -> EventLoopFuture<CreateTapesOutput> {
    ...
    public func deleteBandwidthRateLimit(_ input: DeleteBandwidthRateLimitInput) -> EventLoopFuture<DeleteBandwidthRateLimitOutput> {
    ...
    public func deleteChapCredentials(_ input: DeleteChapCredentialsInput) -> EventLoopFuture<DeleteChapCredentialsOutput> {
        return client.send(operation: "DeleteChapCredentials", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes a file share from a file gateway. This operation is only supported for file gateways.
    public func deleteFileShare(_ input: DeleteFileShareInput) -> EventLoopFuture<DeleteFileShareOutput> {
        return client.send(operation: "DeleteFileShare", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func deleteGateway(_ input: DeleteGatewayInput) -> EventLoopFuture<DeleteGatewayOutput> {
        return client.send(operation: "DeleteGateway", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func deleteSnapshotSchedule(_ input: DeleteSnapshotScheduleInput) -> EventLoopFuture<DeleteSnapshotScheduleOutput> {
        return client.send(operation: "DeleteSnapshotSchedule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified virtual tape. This operation is only supported in the tape gateway type.
    public func deleteTape(_ input: DeleteTapeInput) -> EventLoopFuture<DeleteTapeOutput> {
        return client.send(operation: "DeleteTape", path: "/", httpMethod: "POST", input: input)
    }

    ///  Deletes the specified virtual tape from the virtual tape shelf (VTS). This operation is only supported in the tape gateway type.
    public func deleteTapeArchive(_ input: DeleteTapeArchiveInput) -> EventLoopFuture<DeleteTapeArchiveOutput> {
        return client.send(operation: "DeleteTapeArchive", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func deleteVolume(_ input: DeleteVolumeInput) -> EventLoopFuture<DeleteVolumeOutput> {
        return client.send(operation: "DeleteVolume", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns information about the most recent High Availability monitoring test that was performed on the host in a cluster. If a test isn't performed, the status and start time in the response would be null.
    public func describeAvailabilityMonitorTest(_ input: DescribeAvailabilityMonitorTestInput) -> EventLoopFuture<DescribeAvailabilityMonitorTestOutput> {
    ...
    public func describeBandwidthRateLimit(_ input: DescribeBandwidthRateLimitInput) -> EventLoopFuture<DescribeBandwidthRateLimitOutput> {
    ...
    public func describeCache(_ input: DescribeCacheInput) -> EventLoopFuture<DescribeCacheOutput> {
        return client.send(operation: "DescribeCache", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeCachediSCSIVolumes(_ input: DescribeCachediSCSIVolumesInput) -> EventLoopFuture<DescribeCachediSCSIVolumesOutput> {
    ...
    public func describeChapCredentials(_ input: DescribeChapCredentialsInput) -> EventLoopFuture<DescribeChapCredentialsOutput> {
    ...
    public func describeGatewayInformation(_ input: DescribeGatewayInformationInput) -> EventLoopFuture<DescribeGatewayInformationOutput> {
        return client.send(operation: "DescribeGatewayInformation", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns your gateway's weekly maintenance start time including the day and time of the week. Note that values are in terms of the gateway's time zone.
    public func describeMaintenanceStartTime(_ input: DescribeMaintenanceStartTimeInput) -> EventLoopFuture<DescribeMaintenanceStartTimeOutput> {
        return client.send(operation: "DescribeMaintenanceStartTime", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a description for one or more Network File System (NFS) file shares from a file gateway. This operation is only supported for file gateways.
    public func describeNFSFileShares(_ input: DescribeNFSFileSharesInput) -> EventLoopFuture<DescribeNFSFileSharesOutput> {
        return client.send(operation: "DescribeNFSFileShares", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a description for one or more Server Message Block (SMB) file shares from a file gateway. This operation is only supported for file gateways.
    public func describeSMBFileShares(_ input: DescribeSMBFileSharesInput) -> EventLoopFuture<DescribeSMBFileSharesOutput> {
        return client.send(operation: "DescribeSMBFileShares", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a description of a Server Message Block (SMB) file share settings from a file gateway. This operation is only supported for file gateways.
    public func describeSMBSettings(_ input: DescribeSMBSettingsInput) -> EventLoopFuture<DescribeSMBSettingsOutput> {
        return client.send(operation: "DescribeSMBSettings", path: "/", httpMethod: "POST", input: input)
    }

    ///  Describes the snapshot schedule for the specified gateway volume. The snapshot schedule information includes intervals at which snapshots are automatically initiated on the volume. This operation is only supported in the cached volume and stored volume types.
    public func describeSnapshotSchedule(_ input: DescribeSnapshotScheduleInput) -> EventLoopFuture<DescribeSnapshotScheduleOutput> {
        return client.send(operation: "DescribeSnapshotSchedule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns the description of the gateway volumes specified in the request. The list of gateway volumes in the request must be from one gateway. In the response Amazon Storage Gateway returns volume information sorted by volume ARNs. This operation is only supported in stored volume gateway type.
    public func describeStorediSCSIVolumes(_ input: DescribeStorediSCSIVolumesInput) -> EventLoopFuture<DescribeStorediSCSIVolumesOutput> {
        return client.send(operation: "DescribeStorediSCSIVolumes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeTapeArchives(_ input: DescribeTapeArchivesInput) -> EventLoopFuture<DescribeTapeArchivesOutput> {
        return client.send(operation: "DescribeTapeArchives", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a list of virtual tape recovery points that are available for the specified tape gateway. A recovery point is a point-in-time view of a virtual tape at which all the data on the virtual tape is consistent. If your gateway crashes, virtual tapes that have recovery points can be recovered to a new gateway. This operation is only supported in the tape gateway type.
    public func describeTapeRecoveryPoints(_ input: DescribeTapeRecoveryPointsInput) -> EventLoopFuture<DescribeTapeRecoveryPointsOutput> {
        return client.send(operation: "DescribeTapeRecoveryPoints", path: "/", httpMethod: "POST", input: input)
    }

    ///  Returns a description of the specified Amazon Resource Name (ARN) of virtual tapes. If a TapeARN is not specified, returns a description of all virtual tapes associated with the specified gateway. This operation is only supported in the tape gateway type.
    public func describeTapes(_ input: DescribeTapesInput) -> EventLoopFuture<DescribeTapesOutput> {
        return client.send(operation: "DescribeTapes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeUploadBuffer(_ input: DescribeUploadBufferInput) -> EventLoopFuture<DescribeUploadBufferOutput> {
        return client.send(operation: "DescribeUploadBuffer", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeVTLDevices(_ input: DescribeVTLDevicesInput) -> EventLoopFuture<DescribeVTLDevicesOutput> {
        return client.send(operation: "DescribeVTLDevices", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeWorkingStorage(_ input: DescribeWorkingStorageInput) -> EventLoopFuture<DescribeWorkingStorageOutput> {
    ...
    public func detachVolume(_ input: DetachVolumeInput) -> EventLoopFuture<DetachVolumeOutput> {
    ...
    public func disableGateway(_ input: DisableGatewayInput) -> EventLoopFuture<DisableGatewayOutput> {
        return client.send(operation: "DisableGateway", path: "/", httpMethod: "POST", input: input)
    }

    ///  Adds a file gateway to an Active Directory domain. This operation is only supported for file gateways that support the SMB file protocol.
    public func joinDomain(_ input: JoinDomainInput) -> EventLoopFuture<JoinDomainOutput> {
        return client.send(operation: "JoinDomain", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets a list of the file shares for a specific file gateway, or the list of file shares that belong to the calling user account. This operation is only supported for file gateways.
    public func listFileShares(_ input: ListFileSharesInput) -> EventLoopFuture<ListFileSharesOutput> {
        return client.send(operation: "ListFileShares", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listGateways(_ input: ListGatewaysInput) -> EventLoopFuture<ListGatewaysOutput> {
    ...
    public func listLocalDisks(_ input: ListLocalDisksInput) -> EventLoopFuture<ListLocalDisksOutput> {
    ...
    public func listTapes(_ input: ListTapesInput) -> EventLoopFuture<ListTapesOutput> {
        return client.send(operation: "ListTapes", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists iSCSI initiators that are connected to a volume. You can use this operation to determine whether a volume is being used or not. This operation is only supported in the cached volume and stored volume gateway types.
    public func listVolumeInitiators(_ input: ListVolumeInitiatorsInput) -> EventLoopFuture<ListVolumeInitiatorsOutput> {
        return client.send(operation: "ListVolumeInitiators", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listVolumeRecoveryPoints(_ input: ListVolumeRecoveryPointsInput) -> EventLoopFuture<ListVolumeRecoveryPointsOutput> {
        return client.send(operation: "ListVolumeRecoveryPoints", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listVolumes(_ input: ListVolumesInput) -> EventLoopFuture<ListVolumesOutput> {
        return client.send(operation: "ListVolumes", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func notifyWhenUploaded(_ input: NotifyWhenUploadedInput) -> EventLoopFuture<NotifyWhenUploadedOutput> {
    ...
    public func refreshCache(_ input: RefreshCacheInput) -> EventLoopFuture<RefreshCacheOutput> {
        return client.send(operation: "RefreshCache", path: "/", httpMethod: "POST", input: input)
    }

    ///  Removes one or more tags from the specified resource. This operation is supported in storage gateways of all types.
    public func removeTagsFromResource(_ input: RemoveTagsFromResourceInput) -> EventLoopFuture<RemoveTagsFromResourceOutput> {
    ...
    public func resetCache(_ input: ResetCacheInput) -> EventLoopFuture<ResetCacheOutput> {
        return client.send(operation: "ResetCache", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func retrieveTapeArchive(_ input: RetrieveTapeArchiveInput) -> EventLoopFuture<RetrieveTapeArchiveOutput> {
        return client.send(operation: "RetrieveTapeArchive", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func retrieveTapeRecoveryPoint(_ input: RetrieveTapeRecoveryPointInput) -> EventLoopFuture<RetrieveTapeRecoveryPointOutput> {
        return client.send(operation: "RetrieveTapeRecoveryPoint", path: "/", httpMethod: "POST", input: input)
    }

    ///  Sets the password for your VM local console. When you log in to the local console for the first time, you log in to the VM with the default credentials. We recommend that you set a new password. You don't need to know the default password to set a new password.
    public func setLocalConsolePassword(_ input: SetLocalConsolePasswordInput) -> EventLoopFuture<SetLocalConsolePasswordOutput> {
        return client.send(operation: "SetLocalConsolePassword", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func setSMBGuestPassword(_ input: SetSMBGuestPasswordInput) -> EventLoopFuture<SetSMBGuestPasswordOutput> {
        return client.send(operation: "SetSMBGuestPassword", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func shutdownGateway(_ input: ShutdownGatewayInput) -> EventLoopFuture<ShutdownGatewayOutput> {
    ...
    public func startAvailabilityMonitorTest(_ input: StartAvailabilityMonitorTestInput) -> EventLoopFuture<StartAvailabilityMonitorTestOutput> {
    ...
    public func startGateway(_ input: StartGatewayInput) -> EventLoopFuture<StartGatewayOutput> {
    ...
    public func updateBandwidthRateLimit(_ input: UpdateBandwidthRateLimitInput) -> EventLoopFuture<UpdateBandwidthRateLimitOutput> {
    ...
    public func updateChapCredentials(_ input: UpdateChapCredentialsInput) -> EventLoopFuture<UpdateChapCredentialsOutput> {
    ...
    public func updateGatewayInformation(_ input: UpdateGatewayInformationInput) -> EventLoopFuture<UpdateGatewayInformationOutput> {
        return client.send(operation: "UpdateGatewayInformation", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateGatewaySoftwareNow(_ input: UpdateGatewaySoftwareNowInput) -> EventLoopFuture<UpdateGatewaySoftwareNowOutput> {
        return client.send(operation: "UpdateGatewaySoftwareNow", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates a gateway's weekly maintenance start time information, including day and time of the week. The maintenance time is the time in your gateway's time zone.
    public func updateMaintenanceStartTime(_ input: UpdateMaintenanceStartTimeInput) -> EventLoopFuture<UpdateMaintenanceStartTimeOutput> {
        return client.send(operation: "UpdateMaintenanceStartTime", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateNFSFileShare(_ input: UpdateNFSFileShareInput) -> EventLoopFuture<UpdateNFSFileShareOutput> {
        return client.send(operation: "UpdateNFSFileShare", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateSMBFileShare(_ input: UpdateSMBFileShareInput) -> EventLoopFuture<UpdateSMBFileShareOutput> {
        return client.send(operation: "UpdateSMBFileShare", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateSMBSecurityStrategy(_ input: UpdateSMBSecurityStrategyInput) -> EventLoopFuture<UpdateSMBSecurityStrategyOutput> {
        return client.send(operation: "UpdateSMBSecurityStrategy", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func updateSnapshotSchedule(_ input: UpdateSnapshotScheduleInput) -> EventLoopFuture<UpdateSnapshotScheduleOutput> {
        return client.send(operation: "UpdateSnapshotSchedule", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates the type of medium changer in a tape gateway. When you activate a tape gateway, you select a medium changer type for the tape gateway. This operation enables you to select a different type of medium changer after a tape gateway is activated. This operation is only supported in the tape gateway type.
    public func updateVTLDeviceType(_ input: UpdateVTLDeviceTypeInput) -> EventLoopFuture<UpdateVTLDeviceTypeOutput> {
        return client.send(operation: "UpdateVTLDeviceType", path: "/", httpMethod: "POST", input: input)
    }
}
