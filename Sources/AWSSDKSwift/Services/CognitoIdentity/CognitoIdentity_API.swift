...
public struct CognitoIdentity {
    ...
    public func createIdentityPool(_ input: CreateIdentityPoolInput) -> EventLoopFuture<IdentityPool> {
    ...
    public func deleteIdentities(_ input: DeleteIdentitiesInput) -> EventLoopFuture<DeleteIdentitiesResponse> {
        return client.send(operation: "DeleteIdentities", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func deleteIdentityPool(_ input: DeleteIdentityPoolInput) -> EventLoopFuture<Void> {
        return client.send(operation: "DeleteIdentityPool", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeIdentity(_ input: DescribeIdentityInput) -> EventLoopFuture<IdentityDescription> {
        return client.send(operation: "DescribeIdentity", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func describeIdentityPool(_ input: DescribeIdentityPoolInput) -> EventLoopFuture<IdentityPool> {
        return client.send(operation: "DescribeIdentityPool", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getCredentialsForIdentity(_ input: GetCredentialsForIdentityInput) -> EventLoopFuture<GetCredentialsForIdentityResponse> {
        return client.send(operation: "GetCredentialsForIdentity", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getId(_ input: GetIdInput) -> EventLoopFuture<GetIdResponse> {
        return client.send(operation: "GetId", path: "/", httpMethod: "POST", input: input)
    }

    ///  Gets the roles for an identity pool. You must use AWS Developer credentials to call this API.
    public func getIdentityPoolRoles(_ input: GetIdentityPoolRolesInput) -> EventLoopFuture<GetIdentityPoolRolesResponse> {
        return client.send(operation: "GetIdentityPoolRoles", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getOpenIdToken(_ input: GetOpenIdTokenInput) -> EventLoopFuture<GetOpenIdTokenResponse> {
        return client.send(operation: "GetOpenIdToken", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func getOpenIdTokenForDeveloperIdentity(_ input: GetOpenIdTokenForDeveloperIdentityInput) -> EventLoopFuture<GetOpenIdTokenForDeveloperIdentityResponse> {
        return client.send(operation: "GetOpenIdTokenForDeveloperIdentity", path: "/", httpMethod: "POST", input: input)
    }

    ///  Lists the identities in an identity pool. You must use AWS Developer credentials to call this API.
    public func listIdentities(_ input: ListIdentitiesInput) -> EventLoopFuture<ListIdentitiesResponse> {
    ...
    public func listIdentityPools(_ input: ListIdentityPoolsInput) -> EventLoopFuture<ListIdentityPoolsResponse> {
        return client.send(operation: "ListIdentityPools", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func listTagsForResource(_ input: ListTagsForResourceInput) -> EventLoopFuture<ListTagsForResourceResponse> {
    ...
    public func lookupDeveloperIdentity(_ input: LookupDeveloperIdentityInput) -> EventLoopFuture<LookupDeveloperIdentityResponse> {
        return client.send(operation: "LookupDeveloperIdentity", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func mergeDeveloperIdentities(_ input: MergeDeveloperIdentitiesInput) -> EventLoopFuture<MergeDeveloperIdentitiesResponse> {
        return client.send(operation: "MergeDeveloperIdentities", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func setIdentityPoolRoles(_ input: SetIdentityPoolRolesInput) -> EventLoopFuture<Void> {
        return client.send(operation: "SetIdentityPoolRoles", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func tagResource(_ input: TagResourceInput) -> EventLoopFuture<TagResourceResponse> {
    ...
    @discardableResult public func unlinkDeveloperIdentity(_ input: UnlinkDeveloperIdentityInput) -> EventLoopFuture<Void> {
        return client.send(operation: "UnlinkDeveloperIdentity", path: "/", httpMethod: "POST", input: input)
    }
    ...
    @discardableResult public func unlinkIdentity(_ input: UnlinkIdentityInput) -> EventLoopFuture<Void> {
        return client.send(operation: "UnlinkIdentity", path: "/", httpMethod: "POST", input: input)
    }
    ...
    public func untagResource(_ input: UntagResourceInput) -> EventLoopFuture<UntagResourceResponse> {
        return client.send(operation: "UntagResource", path: "/", httpMethod: "POST", input: input)
    }

    ///  Updates an identity pool. You must use AWS Developer credentials to call this API.
    public func updateIdentityPool(_ input: IdentityPool) -> EventLoopFuture<IdentityPool> {
        return client.send(operation: "UpdateIdentityPool", path: "/", httpMethod: "POST", input: input)
    }
}
